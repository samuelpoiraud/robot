...
junction.exe -d R_D\Balise_Emettrice\CurrentSoftware\QS
junction.exe -d R_D\Balise_Emettrice\CurrentSoftware\stm32f4xx
junction.exe -d R_D\Balise_Receptrice\CurrentSoftware\QS
junction.exe -d R_D\Balise_Receptrice\CurrentSoftware\stm32f4xx
pause
