...
/**
  ...
  *         This function returns the last transfert length
  * @param  pdev: Selected device
...
/**
  ...
  * @retval status 
  */
Uint32 HCD_HC_Init (USB_OTG_CORE_HANDLE *pdev , Uint8 hc_num) 
{
...
/**
  ...
  * @retval status
  */
Uint32 HCD_SubmitRequest (USB_OTG_CORE_HANDLE *pdev , Uint8 hc_num) 
{
  
  pdev->host.URB_State[hc_num] =   URB_INPROGRESS;  
