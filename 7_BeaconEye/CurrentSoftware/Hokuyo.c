...
#include "main.h"
	...
	#include "QS_hokuyo/usbh_usr.h"
	#include "QS_hokuyo/STM32_USB_OTG_Driver/usb_hcd_int.h"
	#include "QS_hokuyo/STM32_USB_OTG_Driver/usb_bsp.h"
	#include "QS_hokuyo/STM32_USB_HOST_Library/Class/CDC/usbh_cdc_core.h"
	#include "QS_hokuyo/STM32_USB_HOST_Library/Class/MSC/usbh_msc_core.h"
	#include "QS_hokuyo/STM32_USB_HOST_Library/Class/usbh_class_switch.h"
