...
/* Non implémenté
 ** Numero du timer à utiliser pour utiliser le Remote Control.
 *
 * Si non défini, aucun timer ne sera utilisé et cette fonctionnalité ne sera pas disponible.
 *
#ifndef CW_REMOTE_CONTROL_TIMER
#define CW_REMOTE_CONTROL_TIMER
#undef  CW_REMOTE_CONTROL_TIMER
#endif*/
