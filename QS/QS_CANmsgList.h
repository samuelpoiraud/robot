 ...
 *****************************************************************/
	...
	#define ASSER_CALIBRATION					0x10B
		#define ASSER_CALIBRATION_SQUARE_0		0x00	//Near gifts
		#define ASSER_CALIBRATION_SQUARE_1		0x00
		#define ASSER_CALIBRATION_SQUARE_2		0x00
		#define ASSER_CALIBRATION_SQUARE_3		0x00
		#define ASSER_CALIBRATION_SQUARE_4		0x00	//Near cake
