...
/** Position en degré de l'ax12 lorsque TORCH_LOCKER est rentré  */
	#define TORCH_LOCKER_AX12_1_LOCK_POS            150    //en degré
/** Position en degré de l'ax12 lorsque TORCH_LOCKER est mi sortie */
	#define TORCH_LOCKER_AX12_1_UNLOCK_POS			155    //en degré^
...
/** Position initiale de l'AX12. */
	#define TORCH_LOCKER_AX12_1_INIT_POS        TORCH_LOCKER_AX12_1_LOCK_POS

	#define TORCH_LOCKER_AX12_1_MAX_VALUE	0
	#define TORCH_LOCKER_AX12_1_MIN_VALUE	300
...
/** Position en degré de l'ax12 lorsque TORCH_LOCKER est rentré  */
	#define TORCH_LOCKER_AX12_2_LOCK_POS            150    //en degré
/** Position en degré de l'ax12 lorsque TORCH_LOCKER est mi sortie */
	#define TORCH_LOCKER_AX12_2_UNLOCK_POS			155    //en degré^
/** Tension maximale en pourcentage de l'ax12. Utilisé pour limiter le courant dans le moteur  */
...
/** Position initiale de l'AX12. */
	#define TORCH_LOCKER_AX12_2_INIT_POS        TORCH_LOCKER_AX12_1_LOCK_POS

	#define TORCH_LOCKER_AX12_2_MAX_VALUE	0
	#define TORCH_LOCKER_AX12_2_MIN_VALUE	300
