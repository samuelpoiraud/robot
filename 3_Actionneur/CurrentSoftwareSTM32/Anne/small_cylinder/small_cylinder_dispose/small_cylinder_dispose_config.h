...
//Config
	...
	#define SMALL_CYLINDER_DISPOSE_AX12_MAX_TORQUE_PERCENT		    50		// Couple maximum en pourcentage de l'ax12. Utilisé pour limiter le courant dans le moteur. A mettre a une valeur correcte pour pincer assez fort sans risquer d'endommager l'AX12.
...
//Position
	#define SMALL_CYLINDER_DISPOSE_AX12_IDLE_POS					993
	#define SMALL_CYLINDER_DISPOSE_AX12_TAKE_POS				    883		//en degré
	#define SMALL_CYLINDER_DISPOSE_AX12_RAISE_POS				903		//en degré
	#define SMALL_CYLINDER_DISPOSE_AX12_DISPOSE_POS				571		//en degré
