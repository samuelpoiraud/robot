...
*
*	Fichier : SMALL_CYLINDER_ELEVATOR_rx24_config.c
...
//Position
    #define SMALL_CYLINDER_ELEVATOR_RX24_IDLE_POS					350
    #define SMALL_CYLINDER_ELEVATOR_RX24_TOP_POS			     		702	//en degré
    #define SMALL_CYLINDER_ELEVATOR_RX24_BOTTOM_POS					350	//en degré
