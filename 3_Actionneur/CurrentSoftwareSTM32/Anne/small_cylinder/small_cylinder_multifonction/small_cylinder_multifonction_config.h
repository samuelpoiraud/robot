...
//Position
	#define SMALL_CYLINDER_MULTIFONCTION_AX12_IDLE_POS					512
	#define SMALL_CYLINDER_MULTIFONCTION_AX12_LOCK_POS					512		//en degré
	#define SMALL_CYLINDER_MULTIFONCTION_AX12_PUSH_POS					512		//en degré
	#define SMALL_CYLINDER_MULTIFONCTION_AX12_OUT_POS					512		//en degré
	#define SMALL_CYLINDER_MULTIFONCTION_AX12_IN_POS					512		//en degré
