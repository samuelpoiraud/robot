 ...
 *
 *	Fichier : SMALL_CYLINDER_MULTIFONCTION_ax12.h
 ...
 */
...
#ifndef SMALL_CYLINDER_MULTIFONCTION_H
	#define	SMALL_CYLINDER_MULTIFONCTION_H
	...
	/** Initialisation du gestionnaire de SMALL_CYLINDER_MULTIFONCTION.
	 *
	 * Configure l'asservissement de l'AX12
	 */
	void SMALL_CYLINDER_MULTIFONCTION_init();

	/** Initialisation en position du gestionnaire de SMALL_CYLINDER_MULTIFONCTION.
	 *
	...
	/** Gère les messages CAN liés à la SMALL_CYLINDER_MULTIFONCTION.
	 *
...
#endif	/* SMALL_CYLINDER_MULTIFONCTION_H */
