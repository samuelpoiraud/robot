...
//Config
	#define PENDULUM_RX24_ASSER_TIMEOUT				2000	// Si le RX24 n'atteint pas la position demandée avant ce temps, on considère qu'il y a un problème. Temps en ms.
	...
	#define PENDULUM_RX24_MAX_TORQUE_PERCENT		50		// Couple maximum en pourcentage de le RX24. Utilisé pour limiter le courant dans le moteur. A mettre a une valeur correcte pour pincer assez fort sans risquer d'endommager le RX24.
	#define PENDULUM_RX24_MAX_TEMPERATURE			60		// Température maximale en degré

//Position
	#define PENDULUM_RX24_IDLE_POS					512
	#define PENDULUM_RX24_CLOSE_POS			     	512	//en degré
	#define PENDULUM_RX24_OPEN_POS					512	//en degré
