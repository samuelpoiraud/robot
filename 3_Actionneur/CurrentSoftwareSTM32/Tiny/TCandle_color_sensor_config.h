...
#define	TCANDLE_COLOR_SENSOR_CONFIG_H
	...
	#define CANDLECOLOR_CW_CHANNEL_RED          0
...
//	#define CANDLECOLOR_CW_CHANNEL_YELLOW       3
	...
	#define CANDLECOLOR_CW_MIN_Y                10    //Valeur minimale de Y pour detecter une couleur
...
//	#define CANDLECOLOR_CW_YELLOW_MAX_DIFF_xy   51    //différence maximale entre x et y  pour pouvoir detecter du jaune
	#define CANDLECOLOR_CW_RED_MIN_x            400   //valeur mini de x pour detecter du rouge (x+y+z=1)
	#define CANDLECOLOR_CW_BLUE_MIN_z           450   //valeur mini de z pour detecter du bleue
