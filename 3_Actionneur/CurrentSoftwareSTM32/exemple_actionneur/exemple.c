...
static void EXEMPLE_initAX12() {
	if(ax12_is_initialized == FALSE && AX12_is_ready(EXEMPLE_AX12_ID) == TRUE) {
		...
		AX12_config_set_highest_voltage(EXEMPLE_AX12_ID, AX12_MIN_VOLTAGE);
		...
		AX12_config_set_error_before_led(SMALL_ARM_AX12_ID, AX12_BEFORE_LED);
		AX12_config_set_error_before_shutdown(SMALL_ARM_AX12_ID, AX12_BEFORE_SHUTDOWN);
