...
static void PINCE_GAUCHE_initAX12() {
	if(ax12_is_initialized == FALSE && AX12_is_ready(PINCE_GAUCHE_AX12_ID) == TRUE) {
		...
		AX12_config_set_lowest_voltage(PINCE_GAUCHE_AX12_ID, AX12_MIN_VOLTAGE);
		AX12_config_set_highest_voltage(PINCE_GAUCHE_AX12_ID, AX12_MAX_VOLTAGE);
		AX12_set_torque_limit(PINCE_GAUCHE_AX12_ID, PINCE_GAUCHE_AX12_MAX_TORQUE_PERCENT);
		AX12_config_set_temperature_limit(PINCE_GAUCHE_AX12_ID, PINCE_GAUCHE_AX12_MAX_TEMPERATURE);
		...
		AX12_config_set_error_before_led(PINCE_GAUCHE_AX12_ID, AX12_BEFORE_LED);
		AX12_config_set_error_before_shutdown(PINCE_GAUCHE_AX12_ID, AX12_BEFORE_SHUTDOWN);
