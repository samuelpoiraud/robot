...
//Position
	#define POP_DROP_RIGHT_WOOD_AX12_IDLE_POS					110				//en degré
	#define POP_DROP_RIGHT_WOOD_AX12_MID_POS					110				//en degré
	#define POP_DROP_RIGHT_WOOD_AX12_DEPLOYED_POS				163				//en degré

//Position initiale de l'AX12
	#define POP_DROP_RIGHT_WOOD_AX12_INIT_POS        POP_DROP_RIGHT_WOOD_AX12_IDLE_POS		/** Position initiale de l'AX12. Doit être un define du type POP_DROP_RIGHT_WOOD_AX12_* */
