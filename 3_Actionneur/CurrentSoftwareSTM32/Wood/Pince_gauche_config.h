...
//Position
	#define PINCE_GAUCHE_AX12_CLOSE_POS					74		//en degré
	#define PINCE_GAUCHE_AX12_MID_POS					99		//en degré 25° de diff avec IDLE POS
	#define PINCE_GAUCHE_AX12_OPEN_POS					150 	//en degré
