...
#define OUTPUT_LOG_COMPONENT_POMPE_SAND_LOCKER_LEFT		LOG_PRINT_On
#define OUTPUT_LOG_COMPONENT_POMPE_SAND_LOCKER_RIGHT	LOG_PRINT_On
#define OUTPUT_LOG_COMPONENT_POMPE_BLACK_FRONT_LEFT		LOG_PRINT_On
#define OUTPUT_LOG_COMPONENT_POMPE_BLACK_FRONT_RIGHT	LOG_PRINT_On
#define OUTPUT_LOG_COMPONENT_POMPE_PENDULUM				LOG_PRINT_On
