...
//Config
	...
	#define BACK_SPOT_RIGHT_AX12_ASSER_POS_EPSILON			6				// Lorsque l'ax12 atteint sa position avec +/- POS_EPSILON degré d'écart max, on considère qu'il a atteint sa position. Angle en degré.
	#define BACK_SPOT_RIGHT_AX12_ASSER_POS_LARGE_EPSILON	28				// Si le déplacement de l'ax12 timeout mais que sa position est à +/- POS_LARGE_EPSILON degré d'écart max, on considère qu'il a atteint sa position. Angle en degré.
	...
	#define BACK_SPOT_RIGHT_AX12_MAX_TEMPERATURE             60				// Température maximale en degré
...
//Extremum valeur
	...
	#define BACK_SPOT_RIGHT_AX12_MAX_VALUE					1024
