...
static void POP_DROP_RIGHT_initAX12() {
	if(ax12_is_initialized == FALSE && AX12_is_ready(POP_DROP_RIGHT_AX12_ID) == TRUE) {
		...
		AX12_config_set_lowest_voltage(POP_DROP_RIGHT_AX12_ID, AX12_MIN_VOLTAGE);
		AX12_config_set_highest_voltage(POP_DROP_RIGHT_AX12_ID, AX12_MAX_VOLTAGE);
		AX12_set_torque_limit(POP_DROP_RIGHT_AX12_ID, POP_DROP_RIGHT_AX12_MAX_TORQUE_PERCENT);
		AX12_config_set_temperature_limit(POP_DROP_RIGHT_AX12_ID, POP_DROP_RIGHT_AX12_MAX_TEMPERATURE);
		...
		AX12_config_set_error_before_led(POP_DROP_RIGHT_AX12_ID, AX12_BEFORE_LED);
		AX12_config_set_error_before_shutdown(POP_DROP_RIGHT_AX12_ID, AX12_BEFORE_SHUTDOWN);
