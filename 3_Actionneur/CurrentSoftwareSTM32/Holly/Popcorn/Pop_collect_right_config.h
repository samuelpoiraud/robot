...
//Config
	...
	#define POP_COLLECT_RIGHT_AX12_MAX_TORQUE_PERCENT		60				// Couple maximum en pourcentage de l'ax12. Utilisé pour limiter le courant dans le moteur. A mettre a une valeur correcte pour pincer assez fort sans risquer d'endommager l'AX12.
	#define POP_COLLECT_RIGHT_AX12_MAX_TEMPERATURE          60				// Température maximale en degré

//Position
	#define POP_COLLECT_RIGHT_AX12_IDLE_POS					32				//en degré
	#define POP_COLLECT_RIGHT_AX12_MID_POS					264				//en degré
	#define POP_COLLECT_RIGHT_AX12_OPEN_POS				    426				//en degré
