...
//Config
	...
	#define POP_COLLECT_RIGHT_AX12_ASSER_POS_EPSILON		2				// Lorsque l'ax12 atteint sa position avec +/- POS_EPSILON degré d'écart max, on considère qu'il a atteint sa position. Angle en degré.
	#define POP_COLLECT_RIGHT_AX12_ASSER_POS_LARGE_EPSILON	10				// Si le déplacement de l'ax12 timeout mais que sa position est à +/- POS_LARGE_EPSILON degré d'écart max, on considère qu'il a atteint sa position. Angle en degré.
...
//Position
	#define POP_COLLECT_RIGHT_AX12_IDLE_POS					110				//en degré
	#define POP_COLLECT_RIGHT_AX12_MID_POS					110				//en degré
	#define POP_COLLECT_RIGHT_AX12_DEPLOYED_POS				163				//en degré

//Position initiale de l'AX12
	#define POP_COLLECT_RIGHT_AX12_INIT_POS					POP_COLLECT_RIGHT_AX12_IDLE_POS

//Extremum valeur
	#define POP_COLLECT_RIGHT_AX12_MAX_VALUE				300
