...
//Position initiale du RX24
	#define PINCEMIR_RIGHT_INIT_POS									PINCEMIR_RIGHT_LOCK
	#define PINCEMIR_LEFT_INIT_POS									PINCEMIR_LEFT_LOCK
	#define PINCEMIL_RIGHT_INIT_POS									PINCEMIL_RIGHT_LOCK
	#define PINCEMIL_LEFT_INIT_POS									PINCEMIL_LEFT_LOCK
