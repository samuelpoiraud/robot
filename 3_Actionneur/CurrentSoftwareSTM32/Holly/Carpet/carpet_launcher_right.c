...
static void CARPET_LAUNCHER_RIGHT_initAX12() {
	if(ax12_is_initialized == FALSE && AX12_is_ready(CARPET_LAUNCHER_RIGHT_AX12_ID) == TRUE) {
		...
		AX12_config_set_highest_voltage(CARPET_LAUNCHER_RIGHT_AX12_ID, 136);
		AX12_config_set_lowest_voltage(CARPET_LAUNCHER_RIGHT_AX12_ID, 70);
		AX12_config_set_maximum_torque_percentage(CARPET_LAUNCHER_RIGHT_AX12_ID, CARPET_LAUNCHER_RIGHT_AX12_MAX_TORQUE_PERCENT);
		...
		AX12_config_set_error_before_led(CARPET_LAUNCHER_RIGHT_AX12_ID, AX12_ERROR_ANGLE | AX12_ERROR_CHECKSUM | AX12_ERROR_INSTRUCTION | AX12_ERROR_OVERHEATING | AX12_ERROR_OVERLOAD | AX12_ERROR_RANGE);
		AX12_config_set_error_before_shutdown(CARPET_LAUNCHER_RIGHT_AX12_ID, AX12_ERROR_OVERHEATING);
...
bool_e CARPET_LAUNCHER_RIGHT_CAN_process_msg(CAN_msg_t* msg) {
	if(msg->sid == ACT_CARPET_LAUNCHER_RIGHT){
		...
		SELFTEST_set_actions(&CARPET_LAUNCHER_RIGHT_run_command, 12, 3, (SELFTEST_action_t[]){
								 {ACT_CARPET_LAUNCHER_RIGHT_IDLE,		0,  QUEUE_ACT_AX12_CARPET_LAUNCHER_RIGHT},
								 {ACT_CARPET_LAUNCHER_RIGHT_LAUNCH,		0,  QUEUE_ACT_AX12_CARPET_LAUNCHER_RIGHT},
								 {ACT_CARPET_LAUNCHER_RIGHT_IDLE,		0,  QUEUE_ACT_AX12_CARPET_LAUNCHER_RIGHT}
							 });
	}
	return FALSE;
