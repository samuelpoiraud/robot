...
//Position
    #define ORE_ROLLER_ARM_L_RX24_IDLE_POS					    662
    #define ORE_ROLLER_ARM_L_RX24_OUT_POS			     	    343
    #define ORE_ROLLER_ARM_L_RX24_IN_POS				    	662

    #define ORE_ROLLER_ARM_R_RX24_IDLE_POS					    674
    #define ORE_ROLLER_ARM_R_RX24_OUT_POS			     	    983
    #define ORE_ROLLER_ARM_R_RX24_IN_POS				    	674
