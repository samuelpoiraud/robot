...
static void BIG_BALL_FRONT_LEFT_config(CAN_msg_t* msg);
...
void BIG_BALL_FRONT_LEFT_config(CAN_msg_t* msg){
...
bool_e BIG_BALL_FRONT_LEFT_CAN_process_msg(CAN_msg_t* msg) {
    if(msg->sid == ACT_BIG_BALL_FRONT_LEFT){
		...
		switch(msg->data.act_msg.order) {
            ...
            case ACT_BIG_BALL_FRONT_LEFT_LOCK :
            case ACT_BIG_BALL_FRONT_LEFT_UNLOCK :
			...
			case ACT_CONFIG :
                BIG_BALL_FRONT_LEFT_config(msg);
				break;
...
static void BIG_BALL_FRONT_LEFT_command_init(queue_id_t queueId) {
	...
	*ax12_goalPosition = 0xFFFF;
	...
	switch(command) {
        ...
        case ACT_BIG_BALL_FRONT_LEFT_LOCK : *ax12_goalPosition = BIG_BALL_FRONT_LEFT_AX12_LOCK_POS; break;
        case ACT_BIG_BALL_FRONT_LEFT_UNLOCK : *ax12_goalPosition = BIG_BALL_FRONT_LEFT_AX12_UNLOCK_POS; break;
