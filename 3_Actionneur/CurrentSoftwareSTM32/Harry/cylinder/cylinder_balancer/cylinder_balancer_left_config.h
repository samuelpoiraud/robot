...
//Config
	#define CYLINDER_BALANCER_LEFT_AX12_ASSER_TIMEOUT				3000	// Si l'ax12 n'atteint pas la position demandée avant ce temps, on considère qu'il y a un problème. Temps en ms.
...
//Position
	#define CYLINDER_BALANCER_LEFT_AX12_IDLE_POS					1000
	#define CYLINDER_BALANCER_LEFT_AX12_IN_POS				    	886		//en degré
	#define CYLINDER_BALANCER_LEFT_AX12_OUT_POS						360		//en degré 297
	#define CYLINDER_BALANCER_LEFT_AX12_VERY_OUT_POS				10		//en degré
