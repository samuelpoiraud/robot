...
//Position
    #define CYLINDER_PUSHER_RIGHT_AX12_IDLE_POS						672
    #define CYLINDER_PUSHER_RIGHT_AX12_IN_POS				   	 	672		//en degré
    #define CYLINDER_PUSHER_RIGHT_AX12_OUT_POS						381		//en degré
