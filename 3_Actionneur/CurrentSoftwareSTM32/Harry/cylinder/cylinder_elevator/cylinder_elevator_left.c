...
static ACT_order_e CYLINDER_ELEVATOR_LEFT_get_position_config();
...
static void CYLINDER_ELEVATOR_LEFT_check_warner();
...
static ACT_order_e CYLINDER_ELEVATOR_LEFT_get_position_config(){
	ACT_order_e current_state = ACT_CYLINDER_ELEVATOR_LEFT_STOP;
...
static void CYLINDER_ELEVATOR_LEFT_command_run(queue_id_t queueId) {
    ...
    if(ACTQ_check_status_rx24(queueId, CYLINDER_ELEVATOR_LEFT_RX24_ID, QUEUE_get_arg(queueId)->param, CYLINDER_ELEVATOR_LEFT_RX24_ASSER_POS_EPSILON, CYLINDER_ELEVATOR_LEFT_RX24_ASSER_TIMEOUT, CYLINDER_ELEVATOR_LEFT_RX24_ASSER_POS_LARGE_EPSILON, &result, &errorCode, &line))
        QUEUE_next(queueId, ACT_CYLINDER_ELEVATOR_LEFT, result, errorCode, line);

    // On ne surveille le warner que si il est activé
	if(warner.activated)
		CYLINDER_ELEVATOR_LEFT_check_warner();
}
