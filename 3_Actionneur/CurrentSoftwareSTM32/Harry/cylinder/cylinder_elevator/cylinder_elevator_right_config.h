...
//Position
    #define CYLINDER_ELEVATOR_RIGHT_RX24_IDLE_POS					512
    #define CYLINDER_ELEVATOR_RIGHT_RX24_TOP_POS			     	512	//en degré
    #define CYLINDER_ELEVATOR_RIGHT_RX24_BOTTOM_POS					512	//en degré
    #define CYLINDER_ELEVATOR_RIGHT_RX24_LOCK_WITH_CYLINDER_POS		512	//en degré
