...
//Config
    #define CYLINDER_ELEVATOR_RIGHT_RX24_ASSER_TIMEOUT				1250	// Si le RX24 n'atteint pas la position demandée avant ce temps, on considère qu'il y a un problème. Temps en ms.
    ...
    #define CYLINDER_ELEVATOR_RIGHT_RX24_MAX_TORQUE_PERCENT		    90		// Couple maximum en pourcentage de le RX24. Utilisé pour limiter le courant dans le moteur. A mettre a une valeur correcte pour pincer assez fort sans risquer d'endommager le RX24.
...
//Position
    #define CYLINDER_ELEVATOR_RIGHT_RX24_IDLE_POS					620
    #define CYLINDER_ELEVATOR_RIGHT_RX24_TOP_POS			     	265	//en degré (-359 par rapport à BOTTOM_POS)
    #define CYLINDER_ELEVATOR_RIGHT_RX24_BOTTOM_POS					620	//en degré
    #define CYLINDER_ELEVATOR_RIGHT_RX24_LOCK_WITH_CYLINDER_POS		444	//en degré (-176 par rapport à BOTTOM_POS)

	#define	CYLINDER_ELEVATOR_RIGHT_RX24_WARNER_POS					512

//Position initiale de l'RX24
    #define CYLINDER_ELEVATOR_RIGHT_RX24_INIT_POS					CYLINDER_ELEVATOR_RIGHT_RX24_LOCK_WITH_CYLINDER_POS
