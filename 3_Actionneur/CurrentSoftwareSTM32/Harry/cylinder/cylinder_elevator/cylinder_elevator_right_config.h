...
//Position
    #define CYLINDER_ELEVATOR_RIGHT_RX24_IDLE_POS					612
    #define CYLINDER_ELEVATOR_RIGHT_RX24_TOP_POS			     	277	//en degré
    #define CYLINDER_ELEVATOR_RIGHT_RX24_BOTTOM_POS					612	//en degré
