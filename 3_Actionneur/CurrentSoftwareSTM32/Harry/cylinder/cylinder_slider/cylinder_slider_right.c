...
bool_e CYLINDER_SLIDER_RIGHT_CAN_process_msg(CAN_msg_t* msg) {
    if(msg->sid == ACT_CYLINDER_SLIDER_RIGHT){
		...
		switch(msg->data.act_msg.order) {
            ...
            case ACT_CYLINDER_SLIDER_RIGHT_LOCK :
            case ACT_CYLINDER_SLIDER_RIGHT_UNLOCK :
...
static void CYLINDER_SLIDER_RIGHT_command_init(queue_id_t queueId) {
	...
	*rx24_goalPosition = 0xFFFF;
	...
	switch(command) {
        ...
        case ACT_CYLINDER_SLIDER_RIGHT_LOCK : *rx24_goalPosition = CYLINDER_SLIDER_RIGHT_RX24_LOCK_POS; break;
        case ACT_CYLINDER_SLIDER_RIGHT_UNLOCK : *rx24_goalPosition = CYLINDER_SLIDER_RIGHT_RX24_UNLOCK_POS; break;
