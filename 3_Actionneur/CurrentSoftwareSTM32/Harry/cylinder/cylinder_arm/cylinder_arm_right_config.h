...
//Config
    ...
    #define CYLINDER_ARM_RIGHT_RX24_MAX_TORQUE_PERCENT		    50		// Couple maximum en pourcentage de le RX24. Utilisé pour limiter le courant dans le moteur. A mettre a une valeur correcte pour pincer assez fort sans risquer d'endommager le RX24.
    #define CYLINDER_ARM_RIGHT_RX24_MAX_TEMPERATURE				60		// Température maximale en degré
	#define CYLINDER_ARM_RIGHT_RX24_SPEED						100		// Vitesse par défaut du RX24

//Position
    #define CYLINDER_ARM_RIGHT_RX24_IDLE_POS					512
    #define CYLINDER_ARM_RIGHT_RX24_IN_POS			     		512	//en degré
	#define CYLINDER_ARM_RIGHT_RX24_PREPARE_TO_TAKE_POS			512	//en degré
	#define CYLINDER_ARM_RIGHT_RX24_TAKE_POS			     	512	//en degré
	#define CYLINDER_ARM_RIGHT_RX24_DISPOSE_POS			     	512	//en degré
    #define CYLINDER_ARM_RIGHT_RX24_OUT_POS						512	//en degré
