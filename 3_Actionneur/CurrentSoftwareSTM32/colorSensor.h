 ...
 */
	...
	#include "QS/QS_all.h"
		...
		typedef enum{
			COLOR_SENSOR_NONE = COLOR_SENSOR_I2C_NONE,
			COLOR_SENSOR_BLUE = COLOR_SENSOR_I2C_BLUE,
			COLOR_SENSOR_WHITE = COLOR_SENSOR_I2C_WHITE,
			COLOR_SENSOR_YELLOW = COLOR_SENSOR_I2C_YELLOW
