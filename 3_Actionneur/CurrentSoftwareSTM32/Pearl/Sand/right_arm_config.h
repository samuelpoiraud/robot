...
//Config
	#define RIGHT_ARM_AX12_ASSER_TIMEOUT				1000	// Si l'ax12 n'atteint pas la position demandée avant ce temps, on considère qu'il y a un problème. Temps en ms.
	...
	#define RIGHT_ARM_AX12_MAX_TORQUE_PERCENT		    70		// Couple maximum en pourcentage de l'ax12. Utilisé pour limiter le courant dans le moteur. A mettre a une valeur correcte pour pincer assez fort sans risquer d'endommager l'AX12.
	#define RIGHT_ARM_AX12_MAX_TEMPERATURE				60		// Température maximale en degré

//Position
	#define RIGHT_ARM_AX12_IDLE_POS						328
	#define RIGHT_ARM_AX12_LOCK_POS					    638
	#define RIGHT_ARM_AX12_LOCK_SERRAGE_POS				628
