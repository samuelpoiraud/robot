...
static void ACTQ_internal_printResult(Uint11 originalSid, Uint8 originalCommand, Uint8 result, Uint8 errorCode, CAN_result_param_type_t paramType, Uint16 param, bool_e sent_can_result) {
	...
	switch(originalSid) {
		...
		case ACT_CLAP_HOLLY & 0xFF:				originalSidStr = "Clap";					break;
		...
		case ACT_SPOT_POMPE_RIGHT & 0xFF:		originalSidStr = "Spot_pompe_right";		break;
		case ACT_SPOT_POMPE_LEFT & 0xFF:		originalSidStr = "Spot_pompe_left";			break;
