...
#define	KBALL_SORTER_CONFIG_H
	...
	#define BALLSORTER_DETECT_TIME                  5      //Attend x * 0.1 s après que l'AX12 soit rendu à sa position avant de capter la couleur de la cerise (unité: 0.1s  (une valeur de 20 correspond à 0.2s soit 200ms))
