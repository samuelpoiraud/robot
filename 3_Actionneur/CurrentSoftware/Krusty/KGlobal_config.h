...
/* Config PLATE */
	...
	#define PLATE_PLIER_AX12_ASSER_POS_EPSILON   40     //en degré
...
/* Config BALLSORTER */
	...
	#define BALLSORTER_DETECT_TIME               4   //Attend x * 0.1 s après que l'AX12 soit rendu à sa position avant de capter (unité: 0.1s  (une valeur de 20 correspond à 0.2s soit 200ms))
