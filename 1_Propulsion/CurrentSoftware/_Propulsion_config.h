...
//Consultez le Fichier: svn\propulsion\Documentation\TUTO_reglage_odometrie.txt
	...
	//SMALL Position calibration
		...
		#define SMALL_BOT_COLOR_CALIBRATION_Y  		530
		#define SMALL_BOT_COLOR_CALIBRATION_TETA	(0)

		//TOP_COLOR
		#define SMALL_TOP_COLOR_CALIBRATION_X  		1000
		#define SMALL_TOP_COLOR_CALIBRATION_Y  		(3000 - 530)
...
//SMALL  Position initiale
		...
		#define SMALL_BOT_COLOR_START_Y  		(65536*(70+SMALL_CALIBRATION_BACKWARD_BORDER_DISTANCE))
		...
		#define SMALL_TOP_COLOR_START_Y 		(65536*(3000-(70+SMALL_CALIBRATION_BACKWARD_BORDER_DISTANCE)))	//(3000-...)mm
