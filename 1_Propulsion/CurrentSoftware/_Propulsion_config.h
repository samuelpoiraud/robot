...
//Consultez le Fichier: svn\propulsion\Documentation\TUTO_reglage_odometrie.txt
	...
	#define SMALL_ODOMETRY_COEF_ROTATION_DEFAULT	0x0001F1E0
...
//*********************************** POSITIONS CALIBRATIONS 2017 ******************************
	//SMALL
		...
		#define SMALL_BOT_COLOR_CALIBRATION_BASCULE_TETA 		(PI4096/2)			// PI_28  (il part en marche arriere...)
		...
		#define SMALL_TOP_COLOR_CALIBRATION_BASCULE_TETA 	(-PI4096/2)			// PI_28  (il part en marche arriere...)
