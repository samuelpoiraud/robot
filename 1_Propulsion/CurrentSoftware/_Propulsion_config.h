...
//Consultez le Fichier: svn\propulsion\Documentation\TUTO_reglage_odometrie.txt
	...
	//SMALL  Positin initiale
		// BOT_COLOR
		#define SMALL_BOT_COLOR_START_X  		41615360 			//635mm
		#define SMALL_BOT_COLOR_START_Y  		5308416				//81mm
		#define SMALL_BOT_COLOR_START_TETA 	(-6588416)			//-PI/2 //(-3294199)

		// TOP_COLOR
		#define SMALL_TOP_COLOR_START_X 		41615360 			//635mm
		#define SMALL_TOP_COLOR_START_Y 		(196608000-5308416)	//(3000-81)mm
		#define SMALL_TOP_COLOR_START_TETA 	(6588416)				//PI/2 //3294199

	//BIG
		// BOT_COLOR
		#define BIG_BOT_COLOR_START_X  	(730 - BIG_CALIBRATION_WIDTH/2)*65536			// 587mm
		#define BIG_BOT_COLOR_START_Y  	65536 * BIG_CALIBRATION_FORWARD_BORDER_DISTANCE			//155mm
		#define BIG_BOT_COLOR_START_TETA 	6588416				//PI/2

		// TOP_COLOR
		#define BIG_TOP_COLOR_START_X  (730 - BIG_CALIBRATION_WIDTH/2)*65536			// 587mm
		#define BIG_TOP_COLOR_START_Y 	(196608000-(65536 * BIG_CALIBRATION_FORWARD_BORDER_DISTANCE)) //3000-155mm
		#define BIG_TOP_COLOR_START_TETA 	(-6588416)			//-PI/2



	//SMALL Position calibration
		//BOT_COLOR
		#define SMALL_BOT_COLOR_CALIBRATION_X  		535
		#define SMALL_BOT_COLOR_CALIBRATION_Y  		134
		#define SMALL_BOT_COLOR_CALIBRATION_TETA		500    //environ 7°

		//TOP_COLOR
		#define SMALL_TOP_COLOR_CALIBRATION_X  		535
		#define SMALL_TOP_COLOR_CALIBRATION_Y  		(3000 - 134)
		#define SMALL_TOP_COLOR_CALIBRATION_TETA		 -500	//environ -7°

	//BIG
		//BOT_COLOR
		#define BIG_BOT_COLOR_CALIBRATION_X  		243
		#define BIG_BOT_COLOR_CALIBRATION_Y  		191
		#define BIG_BOT_COLOR_CALIBRATION_TETA	1430		//environ 20° (20*71.5)

		//TOP_COLOR
		#define BIG_TOP_COLOR_CALIBRATION_X  		243
		#define BIG_TOP_COLOR_CALIBRATION_Y  		(3000 - 200)
		#define BIG_TOP_COLOR_CALIBRATION_TETA 	11440	 //-20° + 180° fait une rotation à avoir les balles du bon côté
