 ...
 */
	...
	#define WARNING_MOVE			(0b0000000001000000)
	#define WARNING_BRAKE			(0b0000000010000000)
	#define WARNING_ARRIVED			(0b0000000100000000)
	#define WARNING_CALIBRATION_FINISHED	(0b0000001000000000)
	#define WARNING_ERROR			(0b0000010000000000)
