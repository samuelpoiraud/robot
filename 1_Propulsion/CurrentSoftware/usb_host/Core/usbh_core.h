...
#define MSC_PROTOCOL                      0x50	//Bulk only transport
#define CBI_PROTOCOL                      0x01	//Control/Bulk/Interrupt transport with no command completion interrupt
#define CDC_PROTOCOL					  0x01	//device depends... AT commands V.250
...
typedef struct _USBH_USR_PROP
{
  ...
  void (*DeviceSpeedDetected)(Uint8 DeviceSpeed);          /* DeviceSpeed */
