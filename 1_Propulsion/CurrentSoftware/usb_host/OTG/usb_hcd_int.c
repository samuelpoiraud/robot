...
static Uint32 USB_OTG_USBH_handle_sof_ISR(USB_OTG_CORE_HANDLE *pdev);
static Uint32 USB_OTG_USBH_handle_port_ISR(USB_OTG_CORE_HANDLE *pdev);
static Uint32 USB_OTG_USBH_handle_hc_ISR (USB_OTG_CORE_HANDLE *pdev);
static Uint32 USB_OTG_USBH_handle_hc_n_In_ISR (USB_OTG_CORE_HANDLE *pdev ,
											   Uint32 num);
static Uint32 USB_OTG_USBH_handle_hc_n_Out_ISR (USB_OTG_CORE_HANDLE *pdev ,
												Uint32 num);
static Uint32 USB_OTG_USBH_handle_rx_qlvl_ISR (USB_OTG_CORE_HANDLE *pdev);
static Uint32 USB_OTG_USBH_handle_nptxfempty_ISR (USB_OTG_CORE_HANDLE *pdev);
static Uint32 USB_OTG_USBH_handle_ptxfempty_ISR (USB_OTG_CORE_HANDLE *pdev);
static Uint32 USB_OTG_USBH_handle_Disconnect_ISR (USB_OTG_CORE_HANDLE *pdev);
static Uint32 USB_OTG_USBH_handle_IncompletePeriodicXfer_ISR (USB_OTG_CORE_HANDLE *pdev);
...
Uint32 USBH_OTG_ISR_Handler (USB_OTG_CORE_HANDLE *pdev)
{
...
/**
  ...
  * @retval status
  */
Uint32 USB_OTG_USBH_handle_hc_n_Out_ISR (USB_OTG_CORE_HANDLE *pdev , Uint32 num)
{
...
/**
  ...
  * @retval status
  */
Uint32 USB_OTG_USBH_handle_hc_n_In_ISR (USB_OTG_CORE_HANDLE *pdev , Uint32 num)
{
	USB_OTG_HCINTn_TypeDef     hcint;
	USB_OTG_HCGINTMSK_TypeDef  hcintmsk;
	USB_OTG_HCCHAR_TypeDef     hcchar;
...
//			USB_OTG_WRITE_REG32(&pdev->regs.HC_REGS[num]->HCCHAR, hcchar.d32);
//		}
		if(hcchar.b.eptype == EP_TYPE_INTR || hcchar.b.eptype == EP_TYPE_BULK)
		{
			UNMASK_HOST_INT_CHH (num);
			USB_OTG_HC_Halt(pdev, num);
		}
