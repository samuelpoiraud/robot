...
#ifdef USE_ACCURATE_TIME 
static void BSP_SetTime(Uint8 Unit);
static void BSP_Delay(Uint32 nTime,Uint8 Unit);
...
// EXTI_InitTypeDef EXTI_InitStructure;
  ...
  //On appelle nous même la fonction "d'it timer" -> Samuel.
}
/**
