...
/*
	...
	*/
		...
		*/
		...
		//Calage en Y
		ROADMAP_add_order(TRAJECTORY_TRANSLATION, -2000, 0, 0, PROP_RELATIVE, PROP_END_OF_BUFFER, FORWARD, BORDER_MODE_WITH_UPDATE_POSITION, PROP_END_AT_POINT, SLOW, NO_ACKNOWLEDGE, CORRECTOR_ENABLE, AVOID_DISABLED, 2);
...
//on tourne pour aller chercher la deuxième bordure
		...
		ROADMAP_add_order(TRAJECTORY_TRANSLATION, 0, distance, 0, PROP_RELATIVE, PROP_END_OF_BUFFER, FORWARD, BORDER_MODE_WITH_UPDATE_POSITION, PROP_END_AT_POINT, SLOW, NO_ACKNOWLEDGE, CORRECTOR_ENABLE, AVOID_DISABLED, 5);
