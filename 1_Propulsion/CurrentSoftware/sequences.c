...
void SEQUENCES_calibrate(void)
{
	...
	if(QS_WHO_AM_I_get() == BIG_ROBOT)
	{
		...
		ROADMAP_add_order(TRAJECTORY_TRANSLATION, 107, 0, 0, PROP_RELATIVE, PROP_END_OF_BUFFER, FORWARD, NOT_BORDER_MODE, PROP_END_AT_POINT, 16, NO_ACKNOWLEDGE, CORRECTOR_ENABLE, AVOID_DISABLED, 0);
		...
		if(color == BOT_COLOR) //BLUE
			...
			teta = -PI4096/30;
		ROADMAP_add_order(TRAJECTORY_ROTATION, 0, 0, teta, PROP_ABSOLUTE, PROP_END_OF_BUFFER, BACKWARD /*sens*/, NOT_BORDER_MODE, PROP_END_AT_POINT, 16, ACKNOWLEDGE_CALIBRATION, CORRECTOR_ENABLE, AVOID_DISABLED, 1);

		//position sur l'axe de calage
		if(color == BOT_COLOR) //BLUE
			ROADMAP_add_order(TRAJECTORY_TRANSLATION, -95, -10, 0, PROP_RELATIVE, PROP_END_OF_BUFFER, BACKWARD /*sens*/, NOT_BORDER_MODE, PROP_END_AT_POINT, 16, NO_ACKNOWLEDGE, CORRECTOR_ENABLE, AVOID_DISABLED, 2);
		else
...
/*
	...
	*/
		...
		*/
		...
		ROADMAP_add_order(TRAJECTORY_TRANSLATION, 180, y, 0, PROP_ABSOLUTE, PROP_END_OF_BUFFER, BACKWARD, NOT_BORDER_MODE, PROP_END_AT_POINT, FAST, NO_ACKNOWLEDGE, CORRECTOR_ENABLE, AVOID_DISABLED,0);
		...
		if(color == BOT_COLOR)
			...
			angle = -PI4096/2;
		ROADMAP_add_order(TRAJECTORY_ROTATION, 0, 0, -PI4096, PROP_ABSOLUTE, PROP_END_OF_BUFFER, ANY_WAY, NOT_BORDER_MODE, PROP_END_AT_POINT, FAST, NO_ACKNOWLEDGE, CORRECTOR_ENABLE, AVOID_DISABLED,1);
		Sint32 distance = 0;

		//Calage en Y
		ROADMAP_add_order(TRAJECTORY_TRANSLATION, -2000, 0, 0, PROP_RELATIVE, PROP_END_OF_BUFFER, FORWARD, BORDER_MODE_WITH_UPDATE_POSITION, PROP_END_AT_POINT, 20, NO_ACKNOWLEDGE, CORRECTOR_ENABLE, AVOID_DISABLED, 2);

		ROADMAP_add_order(TRAJECTORY_TRANSLATION, -2000, 0, 0, PROP_RELATIVE, PROP_END_OF_BUFFER, FORWARD, BORDER_MODE_WITH_UPDATE_POSITION, PROP_END_AT_POINT, 20, NO_ACKNOWLEDGE, CORRECTOR_TRANSLATION_ONLY, AVOID_DISABLED, 2);


		//Désactivation de la calibration de Pearl 2016
//on se fout au milieu
		ROADMAP_add_order(TRAJECTORY_TRANSLATION, 180-SMALL_CALIBRATION_FORWARD_BORDER_DISTANCE, 0, 0, PROP_RELATIVE, PROP_END_OF_BUFFER,BACKWARD, NOT_BORDER_MODE, PROP_END_AT_POINT, FAST, NO_ACKNOWLEDGE, CORRECTOR_ENABLE, AVOID_DISABLED,3);
...
//on tourne pour aller chercher la deuxième bordure
		if(color == BOT_COLOR)
			...
			angle = PI4096/2;
		ROADMAP_add_order(TRAJECTORY_ROTATION, 0, 0, angle, PROP_ABSOLUTE, PROP_END_OF_BUFFER, ANY_WAY, NOT_BORDER_MODE, PROP_END_AT_POINT, FAST, NO_ACKNOWLEDGE, CORRECTOR_ENABLE, AVOID_DISABLED,4);
		...
		ROADMAP_add_order(TRAJECTORY_TRANSLATION, 0, distance, 0, PROP_RELATIVE, PROP_END_OF_BUFFER, FORWARD, BORDER_MODE_WITH_UPDATE_POSITION, PROP_END_AT_POINT, 20, NO_ACKNOWLEDGE, CORRECTOR_ENABLE, AVOID_DISABLED, 5);

		ROADMAP_add_order(TRAJECTORY_TRANSLATION, 0, distance, 0, PROP_RELATIVE, PROP_END_OF_BUFFER, FORWARD, BORDER_MODE_WITH_UPDATE_POSITION, PROP_END_AT_POINT, 20, NO_ACKNOWLEDGE, CORRECTOR_TRANSLATION_ONLY, AVOID_DISABLED, 5);
		...
		if(color==BOT_COLOR)
			...
			y = -180 + SMALL_CALIBRATION_FORWARD_BORDER_DISTANCE;
		ROADMAP_add_order(TRAJECTORY_TRANSLATION, 0, y, 0, PROP_RELATIVE, PROP_END_OF_BUFFER, BACKWARD, NOT_BORDER_MODE, PROP_END_AT_POINT, FAST, NO_ACKNOWLEDGE, CORRECTOR_ENABLE, AVOID_DISABLED,6);

		//On fait le demi tour
		ROADMAP_add_order(TRAJECTORY_ROTATION, 0, 0, PI4096, PROP_RELATIVE, PROP_END_OF_BUFFER, ANY_WAY, NOT_BORDER_MODE, PROP_END_AT_POINT, FAST, NO_ACKNOWLEDGE, CORRECTOR_ENABLE, AVOID_DISABLED,7);
		...
		ROADMAP_add_order(TRAJECTORY_TRANSLATION, 180, y, 0, PROP_ABSOLUTE, PROP_END_OF_BUFFER, FORWARD, NOT_BORDER_MODE, PROP_END_AT_POINT, FAST, NO_ACKNOWLEDGE, CORRECTOR_ENABLE, AVOID_DISABLED,8);
		...
		ROADMAP_add_order(TRAJECTORY_ROTATION, 0, 0, angle, PROP_ABSOLUTE, PROP_END_OF_BUFFER, ANY_WAY, NOT_BORDER_MODE, PROP_END_AT_POINT, FAST, ACKNOWLEDGE_CALIBRATION, CORRECTOR_ENABLE, AVOID_DISABLED,9);
