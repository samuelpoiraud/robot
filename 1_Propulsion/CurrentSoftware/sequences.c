...
/*      //2015
	...
	*/
		...
		*/
		...
		ROADMAP_add_order(TRAJECTORY_TRANSLATION, 800, 0, 0, PROP_RELATIVE, PROP_END_OF_BUFFER, FORWARD, NOT_BORDER_MODE, PROP_NO_MULTIPOINT, FAST, NO_ACKNOWLEDGE, CORRECTOR_ENABLE, AVOID_DISABLED);
