...
void SEQUENCES_calibrate()
{
	...
	if(QS_WHO_AM_I_get() == PIERRE){
		...
		ROADMAP_add_order(TRAJECTORY_TRANSLATION, 870,0, 0, RELATIVE, NOT_NOW, FORWARD, NOT_BORDER_MODE, NO_MULTIPOINT, FAST, NO_ACKNOWLEDGE, CORRECTOR_ENABLE);
		...
		if(color == RED){
			ROADMAP_add_order(TRAJECTORY_TRANSLATION, SMALL_RED_CALIBRATION_X, SMALL_RED_CALIBRATION_Y,0, NOT_RELATIVE, NOT_NOW, BACKWARD, NOT_BORDER_MODE, NO_MULTIPOINT, SLOW, ACKNOWLEDGE_CALIBRATION, CORRECTOR_ENABLE);
			...
			ROADMAP_add_order(TRAJECTORY_TRANSLATION, SMALL_YELLOW_CALIBRATION_X, SMALL_YELLOW_CALIBRATION_Y,0, NOT_RELATIVE, NOT_NOW, BACKWARD, NOT_BORDER_MODE, NO_MULTIPOINT, SLOW, ACKNOWLEDGE_CALIBRATION, CORRECTOR_ENABLE);
