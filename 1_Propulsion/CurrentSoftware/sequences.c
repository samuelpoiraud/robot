...
/*
	...
	*/
		...
		if(color == BOT_COLOR){
			...
			ROADMAP_add_order(TRAJECTORY_ROTATION,0,0,(seeing_south_at_the_end)?(-PI4096/2):SMALL_BOT_COLOR_CALIBRATION_TETA, NOT_RELATIVE, NOT_NOW, BACKWARD, NOT_BORDER_MODE, NO_MULTIPOINT, SLOW, ACKNOWLEDGE_CALIBRATION, CORRECTOR_ENABLE, AVOID_DISABLED);
		}else{
			...
			ROADMAP_add_order(TRAJECTORY_ROTATION,0,0,(seeing_south_at_the_end)?(PI4096/2):SMALL_TOP_COLOR_CALIBRATION_TETA, NOT_RELATIVE, NOT_NOW, BACKWARD, NOT_BORDER_MODE, NO_MULTIPOINT, SLOW, ACKNOWLEDGE_CALIBRATION, CORRECTOR_ENABLE, AVOID_DISABLED);
		}
	}
#endif
