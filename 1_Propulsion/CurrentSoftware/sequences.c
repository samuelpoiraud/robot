...
/*
	...
	*/
		...
		*/
		...
		y = (color==BOT_COLOR)? 350:(-350);
		ROADMAP_add_order(TRAJECTORY_TRANSLATION, 0, y, 0, PROP_RELATIVE, PROP_END_OF_BUFFER,BACKWARD, NOT_BORDER_MODE, PROP_END_AT_POINT, FAST, NO_ACKNOWLEDGE, CORRECTOR_ENABLE, AVOID_DISABLED);

		//On s'approche de la bordure où il y le bac à poissons
		ROADMAP_add_order(TRAJECTORY_TRANSLATION, 800, 0, 0, PROP_RELATIVE, PROP_END_OF_BUFFER, FORWARD, NOT_BORDER_MODE, PROP_END_AT_POINT, FAST, NO_ACKNOWLEDGE, CORRECTOR_ENABLE, AVOID_DISABLED);
		...
		//Eloignement de la bordure pour calage en Y
		if(color==BOT_COLOR)
			x = -(2000 - SMALL_BOT_COLOR_CALIBRATION_X - SMALL_CALIBRATION_FORWARD_BORDER_DISTANCE);
		else
			x = -(2000 - SMALL_TOP_COLOR_CALIBRATION_X - SMALL_CALIBRATION_FORWARD_BORDER_DISTANCE);
		ROADMAP_add_order(TRAJECTORY_TRANSLATION, x, 0, 0, PROP_RELATIVE, PROP_END_OF_BUFFER, ANY_WAY, NOT_BORDER_MODE, PROP_END_AT_POINT, FAST, NO_ACKNOWLEDGE, CORRECTOR_ENABLE, AVOID_DISABLED);

		//On s'approche de la bordure rapidement...
		y = (color==BOT_COLOR)?(-300):300;
		ROADMAP_add_order(TRAJECTORY_TRANSLATION, 0, y, 0, PROP_RELATIVE, PROP_END_OF_BUFFER, FORWARD, NOT_BORDER_MODE, PROP_END_AT_POINT, FAST, NO_ACKNOWLEDGE, CORRECTOR_ENABLE, AVOID_DISABLED);
