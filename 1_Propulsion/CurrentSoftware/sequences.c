...
/*
	...
	*/
		...
		*/
		...
		ROADMAP_add_order(TRAJECTORY_TRANSLATION, 0, y, 0, PROP_RELATIVE, PROP_END_OF_BUFFER,BACKWARD, NOT_BORDER_MODE, PROP_END_AT_POINT, FAST, NO_ACKNOWLEDGE, CORRECTOR_ENABLE, AVOID_DISABLED,0);
		...
		//Calage en Y
		ROADMAP_add_order(TRAJECTORY_TRANSLATION, -2000, 0, 0, PROP_RELATIVE, PROP_END_OF_BUFFER, FORWARD, BORDER_MODE_WITH_UPDATE_POSITION, PROP_END_AT_POINT, 30, NO_ACKNOWLEDGE, CORRECTOR_ENABLE, AVOID_DISABLED, 2);

		ROADMAP_add_order(TRAJECTORY_TRANSLATION, -2000, 0, 0, PROP_RELATIVE, PROP_END_OF_BUFFER, FORWARD, BORDER_MODE_WITH_UPDATE_POSITION, PROP_END_AT_POINT, 30, NO_ACKNOWLEDGE, CORRECTOR_TRANSLATION_ONLY, AVOID_DISABLED, 2);
...
//on tourne pour aller chercher la deuxième bordure
		if(color == BOT_COLOR)
			...
			angle = -PI4096/2;
		ROADMAP_add_order(TRAJECTORY_ROTATION, 0, 0, angle, PROP_RELATIVE, PROP_END_OF_BUFFER, FORWARD, NOT_BORDER_MODE, PROP_END_AT_POINT, FAST, NO_ACKNOWLEDGE, CORRECTOR_ENABLE, AVOID_DISABLED,4);
		...
		ROADMAP_add_order(TRAJECTORY_TRANSLATION, 0, distance, 0, PROP_RELATIVE, PROP_END_OF_BUFFER, FORWARD, BORDER_MODE_WITH_UPDATE_POSITION, PROP_END_AT_POINT, 30, NO_ACKNOWLEDGE, CORRECTOR_ENABLE, AVOID_DISABLED, 5);

		ROADMAP_add_order(TRAJECTORY_TRANSLATION, 0, distance, 0, PROP_RELATIVE, PROP_END_OF_BUFFER, FORWARD, BORDER_MODE_WITH_UPDATE_POSITION, PROP_END_AT_POINT, 30, NO_ACKNOWLEDGE, CORRECTOR_TRANSLATION_ONLY, AVOID_DISABLED, 5);
		...
		if(color==BOT_COLOR)
			...
			y = -180 + SMALL_CALIBRATION_FORWARD_BORDER_DISTANCE;
		ROADMAP_add_order(TRAJECTORY_TRANSLATION, 0, y, 0, PROP_RELATIVE, PROP_END_OF_BUFFER, ANY_WAY, NOT_BORDER_MODE, PROP_END_AT_POINT, FAST, NO_ACKNOWLEDGE, CORRECTOR_ENABLE, AVOID_DISABLED,6);

		//On fait le demi tour
		ROADMAP_add_order(TRAJECTORY_ROTATION, 0, 0, PI4096, PROP_RELATIVE, PROP_END_OF_BUFFER, FORWARD, NOT_BORDER_MODE, PROP_END_AT_POINT, FAST, NO_ACKNOWLEDGE, CORRECTOR_ENABLE, AVOID_DISABLED,7);

		//Placement en position finale

		ROADMAP_add_order(TRAJECTORY_TRANSLATION, 0, y, 0, PROP_RELATIVE, PROP_END_OF_BUFFER, ANY_WAY, NOT_BORDER_MODE, PROP_END_AT_POINT, FAST, NO_ACKNOWLEDGE, CORRECTOR_ENABLE, AVOID_DISABLED,8);
