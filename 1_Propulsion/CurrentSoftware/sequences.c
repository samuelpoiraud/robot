...
void SEQUENCES_calibrate(void)
{
	...
	if(QS_WHO_AM_I_get() == BIG_ROBOT)
	{
		...
		if(color == BOT_COLOR) //BLUE
			ROADMAP_add_order(TRAJECTORY_TRANSLATION, 203, 904, 0, PROP_ABSOLUTE, PROP_END_OF_BUFFER, BACKWARD /*sens*/, NOT_BORDER_MODE, PROP_END_AT_POINT, 16, NO_ACKNOWLEDGE, CORRECTOR_ENABLE, AVOID_DISABLED, 2);
		else
			ROADMAP_add_order(TRAJECTORY_TRANSLATION, 203, 2096, 0, PROP_ABSOLUTE, PROP_END_OF_BUFFER, BACKWARD /*sens*/, NOT_BORDER_MODE, PROP_END_AT_POINT, 16, NO_ACKNOWLEDGE, CORRECTOR_ENABLE, AVOID_DISABLED, 2);
