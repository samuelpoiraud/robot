...
void SEQUENCES_calibrate()
{
	...
	if(QS_WHO_AM_I_get() == PIERRE){
		...
		ROADMAP_add_order(TRAJECTORY_TRANSLATION, 100, 0, 0, RELATIVE, NOT_NOW, ANY_WAY, NOT_BORDER_MODE, NO_MULTIPOINT, FAST, NO_ACKNOWLEDGE, CORRECTOR_ENABLE);

		//Calage en X
		SEQUENCES_rush_in_the_wall(PI4096, FORWARD, NO_ACKNOWLEDGE, 0, -4096, BORDER_MODE_WITH_UPDATE_POSITION, CORRECTOR_ENABLE);
		...
		if(color == RED){
			ROADMAP_add_order(TRAJECTORY_TRANSLATION, BIG_RED_CALIBRATION_X, BIG_RED_CALIBRATION_Y,0, NOT_RELATIVE, NOT_NOW, FORWARD, NOT_BORDER_MODE, NO_MULTIPOINT, SLOW, NO_ACKNOWLEDGE, CORRECTOR_ENABLE);
			...
			ROADMAP_add_order(TRAJECTORY_TRANSLATION, BIG_YELLOW_CALIBRATION_X, BIG_YELLOW_CALIBRATION_Y,0, NOT_RELATIVE, NOT_NOW, BACKWARD, NOT_BORDER_MODE, NO_MULTIPOINT, SLOW, NO_ACKNOWLEDGE, CORRECTOR_ENABLE);
		...
		if(color == RED){
			...
			ROADMAP_add_order(TRAJECTORY_ROTATION,0,0,SMALL_RED_CALIBRATION_TETA, NOT_RELATIVE, NOT_NOW, FORWARD, NOT_BORDER_MODE, NO_MULTIPOINT, SLOW, ACKNOWLEDGE_CALIBRATION, CORRECTOR_ENABLE);
		}else{
			...
			ROADMAP_add_order(TRAJECTORY_ROTATION,0,0,SMALL_YELLOW_CALIBRATION_TETA, NOT_RELATIVE, NOT_NOW, FORWARD, NOT_BORDER_MODE, NO_MULTIPOINT, SLOW, ACKNOWLEDGE_CALIBRATION, CORRECTOR_ENABLE);
		}
	}
#endif
