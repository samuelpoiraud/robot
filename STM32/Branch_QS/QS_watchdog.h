...
/** ----------------  Defines possibles  --------------------
 *	USE_WATCHDOG				: Activation de QS_watchdog
 *	WATCHDOG_TIMER				: Numéro du timer choisi pour ce module
 *	WATCHDOG_MAX_COUNT			: Nombre de watchdog max
 *	WATCHDOG_QUANTUM			: Quantum du watchdog voulu [ms]
 */
