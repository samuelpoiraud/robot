...
// Harry
        ...
        ACT_BIG_BALL_FRONT_LEFT_LOCK,
        ACT_BIG_BALL_FRONT_LEFT_UNLOCK,

        ACT_BIG_BALL_FRONT_RIGHT_STOP = 0,
        ACT_BIG_BALL_FRONT_RIGHT_IDLE,
        ACT_BIG_BALL_FRONT_RIGHT_LOCK,
        ACT_BIG_BALL_FRONT_RIGHT_UNLOCK,

        ACT_BIG_BALL_BACK_LEFT_STOP = 0,
        ACT_BIG_BALL_BACK_LEFT_IDLE,
        ACT_BIG_BALL_BACK_LEFT_LOCK,
        ACT_BIG_BALL_BACK_LEFT_UNLOCK,

        ACT_BIG_BALL_BACK_RIGHT_STOP = 0,
        ACT_BIG_BALL_BACK_RIGHT_IDLE,
        ACT_BIG_BALL_BACK_RIGHT_LOCK,
        ACT_BIG_BALL_BACK_RIGHT_UNLOCK,

		ACT_CYLINDER_HACHT_RIGHT_STOP = 0,
		ACT_CYLINDER_HACHT_RIGHT_IDLE,
		ACT_CYLINDER_HACHT_RIGHT_LOCK,
		ACT_CYLINDER_HACHT_RIGHT_UNLOCK,

		ACT_CYLINDER_HACHT_LEFT_STOP = 0,
		ACT_CYLINDER_HACHT_LEFT_IDLE,
		ACT_CYLINDER_HACHT_LEFT_LOCK,
		ACT_CYLINDER_HACHT_LEFT_UNLOCK,
        ...
        ACT_BEARING_BALL_WHEEL_LOCK,
        ACT_BEARING_BALL_WHEEL_UNLOCK,
        ...
        ACT_CYLINDER_ELEVATOR_LEFT_LOCK,
        ACT_CYLINDER_ELEVATOR_LEFT_UNLOCK,
        ...
        ACT_CYLINDER_SLIDER_LEFT_LOCK,
        ACT_CYLINDER_SLIDER_LEFT_UNLOCK,
