 ...
 */
	...
	typedef enum{
			//F_EXEMPLE
			FLAG_OUR_NORTH_CRATER_IS_EMPTY,
			FLAG_OUR_SOUTH_CRATER_IS_EMPTY,
			FLAG_ADV_NORTH_CRATER_IS_EMPTY,
			FLAG_ADV_SOUTH_CRATER_IS_EMPTY,
			FLAG_OUR_CORNER_CRATER_IS_EMPTY,
			FLAG_ADV_CORNER_CRATER_IS_EMPTY,
			...
			FLAG_OUR_MULTICOLOR_START_IS_PRESENT,
			FLAG_OUR_MULTICOLOR_SIDE_IS_PRESENT,
			FLAG_OUR_MULTICOLOR_NEAR_DEPOSE_IS_PRESENT,
			FLAG_ADV_MULTICOLOR_START_IS_PRESENT,
			FLAG_ADV_MULTICOLOR_SIDE_IS_PRESENT,
			FLAG_ADV_MULTICOLOR_NEAR_DEPOSE_IS_PRESENT,
			FLAG_OUR_UNICOLOR_NORTH_IS_PRESENT,
			FLAG_OUR_UNICOLOR_SOUTH_IS_PRESENT,
			FLAG_ADV_UNICOLOR_NORTH_IS_PRESENT, //... laser
			FLAG_ADV_UNICOLOR_SOUTH_IS_PRESENT, //... laser

			//Flag de subaction pour éviter les collisions

			FLAG_HARRY_NORTH_CRATER,
			FLAG_HARRY_SOUTH_CRATER,
			FLAG_HARRY_CORNER_CRATER,
			FLAG_HARRY_DEPOSE_CYLINDER_OUR_SIDE,
			FLAG_HARRY_DEPOSE_CYLINDER_ADV_SIDE,
			FLAG_HARRY_ORE_SHOOTING,
			FLAG_HARRY_DEPOSE_CYLINDER_OUR_DIAGONAL,
			FLAG_HARRY_DEPOSE_CYLINDER_CENTER,
			FLAG_HARRY_DEPOSE_CYLINDER_ADV_DIAGONAL,
			FLAG_HARRY_TAKE_CYLINDER_OUR_ROCKET_UNI,
			FLAG_HARRY_TAKE_CYLINDER_OUR_ROCKET_MULTI,
			FLAG_HARRY_TAKE_CYLINDER_ADV_ROCKET_MULTI,
			FLAG_HARRY_TAKE_CYLINDER_OUR_CENTER,
			FLAG_HARRY_TAKE_CYLINDER_ADV_CENTER,
			FLAG_HARRY_TAKE_CYLINDER_NORTH_UNI,
			FLAG_HARRY_TAKE_CYLINDER_SOUTH_UNI,


			//FLAG_ANNE_NORTH_CRATER,
			//FLAG_ANNE_SOUTH_CRATER,
			//FLAG_ANNE_CORNER_CRATER,
			FLAG_ANNE_DEPOSE_CYLINDER_OUR_SIDE,
			FLAG_ANNE_DEPOSE_CYLINDER_ADV_SIDE,
			//FLAG_ANNE_ORE_SHOOTING,
			FLAG_ANNE_DEPOSE_CYLINDER_OUR_DIAGONAL,
			FLAG_ANNE_DEPOSE_CYLINDER_CENTER,
			FLAG_ANNE_DEPOSE_CYLINDER_ADV_DIAGONAL,
			FLAG_ANNE_TAKE_CYLINDER_OUR_ROCKET_UNI,
			FLAG_ANNE_TAKE_CYLINDER_OUR_ROCKET_MULTI,
			FLAG_ANNE_TAKE_CYLINDER_ADV_ROCKET_MULTI,
			FLAG_ANNE_TAKE_CYLINDER_OUR_CENTER,
			FLAG_ANNE_TAKE_CYLINDER_ADV_CENTER,
			FLAG_ANNE_TAKE_CYLINDER_NORTH_UNI,
			FLAG_ANNE_TAKE_CYLINDER_SOUTH_UNI,
...
// Harry
        ...
        ACT_CYLINDER_ELEVATOR_RIGHT_LOCK,
        ACT_CYLINDER_ELEVATOR_RIGHT_UNLOCK,
        ...
        ACT_CYLINDER_SLIDER_RIGHT_LOCK,
        ACT_CYLINDER_SLIDER_RIGHT_UNLOCK,
