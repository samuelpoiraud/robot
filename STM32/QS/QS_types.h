 ...
 */
	...
	typedef enum{
		...
		//Anne
		SELFTEST_ACT_AX12_SMALL_BALL_BACK_LEFT,
		SELFTEST_ACT_AX12_SMALL_BALL_BACK_RIGHT,
...
// Anne
        ...
        ACT_SMALL_CYLINDER_SLIDER_LOCK,
        ACT_SMALL_CYLINDER_SLIDER_UNLOCK,
        ...
        ACT_SMALL_CYLINDER_MULTIFONCTION_UNLOCK,

        ACT_SMALL_MAGIC_ARM_STOP = 0,
        ACT_SMALL_MAGIC_ARM_IDLE,
        ACT_SMALL_MAGIC_ARM_LOCK,
        ACT_SMALL_MAGIC_ARM_UNLOCK,

        ACT_SMALL_MAGIC_COLOR_STOP = 0,
        ACT_SMALL_MAGIC_COLOR_IDLE,
        ACT_SMALL_MAGIC_COLOR_LOCK,
        ACT_SMALL_MAGIC_COLOR_UNLOCK,

        ACT_SMALL_ORE_STOP = 0,
        ACT_SMALL_ORE_IDLE,
        ACT_SMALL_ORE_LOCK,
        ACT_SMALL_ORE_UNLOCK,
...
//Pompes
	...
	typedef enum{
		MOSFET_BOARD_CURRENT_MEASURE_STATE_OFF,
		MOSFET_BOARD_CURRENT_MEASURE_STATE_ON,
		MOSFET_BOARD_CURRENT_MEASURE_STATE_PUMPING
