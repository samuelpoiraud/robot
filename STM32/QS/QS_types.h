...
// Black
		...
		ACT_BOTTOM_DUNE_LEFT_LOCK,
		ACT_BOTTOM_DUNE_LEFT_UNLOCK,

		ACT_BOTTOM_DUNE_RIGHT_STOP = 0,
		ACT_BOTTOM_DUNE_RIGHT_IDLE,
		ACT_BOTTOM_DUNE_RIGHT_LOCK,
		ACT_BOTTOM_DUNE_RIGHT_UNLOCK,

		ACT_MIDDLE_DUNE_LEFT_STOP = 0,
		ACT_MIDDLE_DUNE_LEFT_IDLE,
		ACT_MIDDLE_DUNE_LEFT_LOCK,
		ACT_MIDDLE_DUNE_LEFT_UNLOCK,

		ACT_MIDDLE_DUNE_RIGHT_STOP = 0,
		ACT_MIDDLE_DUNE_RIGHT_IDLE,
		ACT_MIDDLE_DUNE_RIGHT_LOCK,
		ACT_MIDDLE_DUNE_RIGHT_UNLOCK,
...
// Pearl
		...
		ACT_LEFT_ARM_IDLE,
		ACT_LEFT_ARM_OPEN,
		ACT_LEFT_ARM_VERY_OPEN,
		ACT_LEFT_ARM_CLOSE,

		ACT_RIGHT_ARM_STOP = 0,
		ACT_RIGHT_ARM_IDLE,
		ACT_RIGHT_ARM_OPEN,
		ACT_RIGHT_ARM_VERY_OPEN,
		ACT_RIGHT_ARM_CLOSE,
