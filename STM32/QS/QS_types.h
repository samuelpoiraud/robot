...
// Black
		...
		ACT_FISH_UNSTICK_ARM_UP_TAPOTAGE,
		ACT_FISH_UNSTICK_ARM_DOWN_TAPOTAGE,
		...
		ACT_SHOVEL_DUNE_STOP = 0,
		ACT_SHOVEL_DUNE_IDLE,
		ACT_SHOVEL_DUNE_TAKE,
		ACT_SHOVEL_DUNE_STORE,
		ACT_SHOVEL_DUNE_RESCUE,

		ACT_BRUSH_DUNE_STOP = 0,
		ACT_BRUSH_DUNE_IDLE,
		ACT_BRUSH_DUNE_PUSH_MID,
		ACT_BRUSH_DUNE_PUSH_ALL,
		ACT_BRUSH_DUNE_SUCKER_RELEASE,
...
// Pearl
		...
		ACT_FISH_PEARL_STOP = 0,
		ACT_FISH_PEARL_IDLE,
		ACT_FISH_PEARL_OPEN,
		ACT_FISH_PEARL_CLOSE,
		ACT_FISH_PEARL_TAPOTAGE,
