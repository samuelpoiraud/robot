 ...
 */
	...
	typedef enum{
        ...
        SELFTEST_ACT_AX12_CYLINDER_DISPENSER_LEFT,
        SELFTEST_ACT_AX12_CYLINDER_DISPENSER_RIGHT,
        SELFTEST_ACT_RX24_CYLINDER_ELEVATOR_LEFT,
        SELFTEST_ACT_RX24_CYLINDER_ELEVATOR_RIGHT,
        SELFTEST_ACT_AX12_CYLINDER_HATCH_LEFT,
        SELFTEST_ACT_AX12_CYLINDER_HATCH_RIGHT,
        ...
        SELFTEST_ACT_RX24_CYLINDER_TURN_ARM_LEFT,
        SELFTEST_ACT_RX24_CYLINDER_TURN_ARM_RIGHT,
...
// Harry
		...
		ACT_CYLINDER_SLOPE_RIGHT_LOCK, // DOWN
		ACT_CYLINDER_SLOPE_RIGHT_UNLOCK, // UP

		ACT_CYLINDER_SLOPE_LEFT_STOP = 0,
		ACT_CYLINDER_SLOPE_LEFT_IDLE,
		ACT_CYLINDER_SLOPE_LEFT_LOCK,	// DOWN
		ACT_CYLINDER_SLOPE_LEFT_UNLOCK, // UP

		ACT_CYLINDER_DISPENSER_RIGHT_STOP = 0,		// BALANCER
        ...
        ACT_CYLINDER_PUSHER_RIGHT_LOCK,	//IN
        ACT_CYLINDER_PUSHER_RIGHT_UNLOCK, // OUT

        ACT_CYLINDER_PUSHER_LEFT_STOP = 0,
        ACT_CYLINDER_PUSHER_LEFT_IDLE,
        ACT_CYLINDER_PUSHER_LEFT_LOCK,	// IN
        ACT_CYLINDER_PUSHER_LEFT_UNLOCK,	// OUT
        ...
        ACT_CYLINDER_TURN_RIGHT_ARM_LOCK, //IN
        ACT_CYLINDER_TURN_RIGHT_ARM_UNLOCK, // OUT

        ACT_CYLINDER_TURN_LEFT_ARM_STOP = 0,
        ACT_CYLINDER_TURN_LEFT_ARM_IDLE,
        ACT_CYLINDER_TURN_LEFT_ARM_LOCK,  // IN
        ACT_CYLINDER_TURN_LEFT_ARM_UNLOCK,  // OUT

		ACT_CYLINDER_COLOR_RIGHT_STOP = 0,
		ACT_CYLINDER_COLOR_RIGHT_IDLE,
		ACT_CYLINDER_COLOR_RIGHT_LOCK,
		ACT_CYLINDER_COLOR_RIGHT_UNLOCK,

		ACT_CYLINDER_COLOR_LEFT_STOP = 0,
		ACT_CYLINDER_COLOR_LEFT_IDLE,
		ACT_CYLINDER_COLOR_LEFT_LOCK,
		ACT_CYLINDER_COLOR_LEFT_UNLOCK,
...
// Anne
        ...
        ACT_SMALL_BALL_BACK_LEFT_DOWN,
        ACT_SMALL_BALL_BACK_LEFT_UP,

        ACT_SMALL_BALL_BACK_RIGHT_STOP = 0,
        ACT_SMALL_BALL_BACK_RIGHT_IDLE,
        ACT_SMALL_BALL_BACK_RIGHT_DOWN,
        ACT_SMALL_BALL_BACK_RIGHT_UP,
