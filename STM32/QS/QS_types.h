 ...
 */
	...
	typedef enum{
		...
		SELFTEST_ACT_AX12_BLACK_SAND_CIRCLE,
		SELFTEST_ACT_RX24_BOTTOM_DUNE_LEFT,
		SELFTEST_ACT_RX24_BOTTOM_DUNE_RIGHT,
		SELFTEST_ACT_RX24_MIDDLE_DUNE_LEFT,
		SELFTEST_ACT_RX24_MIDDLE_DUNE_RIGHT,
		...
		SELFTEST_ACT_RX24_POMPE_SAND_LOCKER_LEFT,
		SELFTEST_ACT_RX24_POMPE_SAND_LOCKER_RIGHT,
		SELFTEST_ACT_RX24_POMPE_BLACK_FRONT_LEFT,
		SELFTEST_ACT_RX24_POMPE_BLACK_FRONT_RIGHT,
...
// Black
		...
		ACT_BOTTOM_DUNE_LEFT_STOP = 0,
		ACT_BOTTOM_DUNE_LEFT_IDLE,
		ACT_BOTTOM_DUNE_LEFT_OPEN,
		ACT_BOTTOM_DUNE_LEFT_CLOSE,

		ACT_BOTTOM_DUNE_RIGHT_STOP = 0,
		ACT_BOTTOM_DUNE_RIGHT_IDLE,
		ACT_BOTTOM_DUNE_RIGHT_OPEN,
		ACT_BOTTOM_DUNE_RIGHT_CLOSE,

		ACT_MIDDLE_DUNE_LEFT_STOP = 0,
		ACT_MIDDLE_DUNE_LEFT_IDLE,
		ACT_MIDDLE_DUNE_LEFT_OPEN,
		ACT_MIDDLE_DUNE_LEFT_CLOSE,

		ACT_MIDDLE_DUNE_RIGHT_STOP = 0,
		ACT_MIDDLE_DUNE_RIGHT_IDLE,
		ACT_MIDDLE_DUNE_RIGHT_OPEN,
		ACT_MIDDLE_DUNE_RIGHT_CLOSE,
		...
		ACT_SAND_LOCKER_LEFT_OPEN,
		ACT_SAND_LOCKER_LEFT_CLOSE,

		ACT_SAND_LOCKER_RIGHT_STOP = 0,
		ACT_SAND_LOCKER_RIGHT_IDLE,
		ACT_SAND_LOCKER_RIGHT_OPEN,
		ACT_SAND_LOCKER_RIGHT_CLOSE,
		...
		ACT_POMPE_SAND_LOCKER_LEFT_STOP = 0,
		ACT_POMPE_SAND_LOCKER_LEFT_NORMAL,

		ACT_POMPE_SAND_LOCKER_RIGHT_STOP = 0,
		ACT_POMPE_SAND_LOCKER_RIGHT_NORMAL,

		ACT_POMPE_BLACK_FRONT_LEFT_STOP = 0,
		ACT_POMPE_BLACK_FRONT_LEFT_NORMAL,

		ACT_POMPE_BLACK_FRONT_RIGHT_STOP = 0,
		ACT_POMPE_BLACK_FRONT_RIGHT_NORMAL,

		ACT_POMPE_PENDULUM_STOP = 0,
		ACT_POMPE_PENDULUM_NORMAL,

		ACT_POMPE_VERY_LEFT_STOP = 0,
		ACT_POMPE_VERY_LEFT_NORMAL,

		ACT_POMPE_LEFT_STOP = 0,
		ACT_POMPE_LEFT_NORMAL,

		ACT_POMPE_MIDDLE_LEFT_STOP = 0,
		ACT_POMPE_MIDDLE_LEFT_NORMAL,

		ACT_POMPE_MIDDLE_STOP = 0,
		ACT_POMPE_MIDDLE_NORMAL,

		ACT_POMPE_MIDDLE_RIGHT_STOP = 0,
		ACT_POMPE_MIDDLE_RIGHT_NORMAL,

		ACT_POMPE_RIGHT_STOP = 0,
		ACT_POMPE_RIGHT_NORMAL,

		ACT_POMPE_VERY_RIGHT_STOP = 0,
		ACT_POMPE_VERY_RIGHT_NORMAL,

		ACT_POMPE_ALL_STOP = 0,
		ACT_POMPE_ALL_NORMAL,

		ACT_POMPE_VERY_ALL_STOP = 0,
		ACT_POMPE_VERY_ALL_NORMAL,
...
// Pearl
		...
		ACT_POMPE_BACK_LEFT_STOP = 0,
		ACT_POMPE_BACK_LEFT_NORMAL,

		ACT_POMPE_BACK_RIGHT_STOP = 0,
		ACT_POMPE_BACK_RIGHT_NORMAL,

		ACT_POMPE_FRONT_LEFT_STOP = 0,
		ACT_POMPE_FRONT_LEFT_NORMAL,
		ACT_POMPE_FRONT_LEFT_REVERSE,
