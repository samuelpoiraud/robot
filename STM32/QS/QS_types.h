 ...
 */
	...
	typedef enum{
		...
		SELFTEST_ACT_RX24_TOP_PLATE_LEFT,
		SELFTEST_ACT_RX24_TOP_PLATE_RIGHT,
...
// Black
		ACT_FISH_BRUSH_FRONT_STOP = 0,
		ACT_FISH_BRUSH_FRONT_IDLE,
		ACT_FISH_BRUSH_FRONT_OPEN,
		ACT_FISH_BRUSH_FRONT_LIFT,
		ACT_FISH_BRUSH_FRONT_CLOSE,

		ACT_FISH_BRUSH_BACK_STOP = 0,
		ACT_FISH_BRUSH_BACK_IDLE,
		ACT_FISH_BRUSH_BACK_OPEN,
		ACT_FISH_BRUSH_BACK_LIFT,
		ACT_FISH_BRUSH_BACK_CLOSE,

		ACT_TOP_PLATE_LEFT_STOP = 0,
		ACT_TOP_PLATE_LEFT_IDLE,
		ACT_TOP_PLATE_LEFT_OPEN,
		ACT_TOP_PLATE_LEFT_CLOSE,

		ACT_TOP_PLATE_RIGHT_STOP = 0,
		ACT_TOP_PLATE_RIGHT_IDLE,
