...
// Mosfets
	...
	switch(msg->sid)
	{
		...
		case XBEE_SYNC_ELEMENTS_FLAGS:			switch(msg->data.xbee_sync_elements_flags.flagId)
												{
													case COQUILLAGE_AWAY_ONE:			print(string, len, "COQUILLAGE_AWAY_ONE");			break;
													case COQUILLAGE_AWAY_TWO:			print(string, len, "COQUILLAGE_AWAY_TWO");			break;
													case COQUILLAGE_AWAY_THREE:			print(string, len, "COQUILLAGE_AWAY_THREE");		break;
													case COQUILLAGE_AWAY_FOUR:			print(string, len, "COQUILLAGE_AWAY_FOUR");			break;
													case COQUILLAGE_AWAY_FIVE:			print(string, len, "COQUILLAGE_AWAY_FIVE");			break;
													case COQUILLAGE_AWAY_ROCK_ONE:		print(string, len, "COQUILLAGE_AWAY_ROCK_ONE");		break;
													case COQUILLAGE_AWAY_ROCK_TWO:		print(string, len, "COQUILLAGE_AWAY_ROCK_TWO");		break;
													case COQUILLAGE_AWAY_ROCK_THREE:	print(string, len, "COQUILLAGE_AWAY_ROCK_THREE");	break;
													case COQUILLAGE_NEUTRAL_ONE:		print(string, len, "COQUILLAGE_NEUTRAL_ONE");		break;
													case COQUILLAGE_NEUTRAL_TWO:		print(string, len, "COQUILLAGE_NEUTRAL_TWO");		break;
													case COQUILLAGE_NEUTRAL_THREE:		print(string, len, "COQUILLAGE_NEUTRAL_THREE");		break;
													case COQUILLAGE_NEUTRAL_FOUR:		print(string, len, "COQUILLAGE_NEUTRAL_FOUR");		break;
													case COQUILLAGE_NEUTRAL_FIVE:		print(string, len, "COQUILLAGE_NEUTRAL_FIVE");		break;
													case COQUILLAGE_NEUTRAL_SIX:		print(string, len, "COQUILLAGE_NEUTRAL_SIX");		break;
													case COQUILLAGE_HOME_ONE:			print(string, len, "COQUILLAGE_HOME_ONE");			break;
													case COQUILLAGE_HOME_TWO:			print(string, len, "COQUILLAGE_HOME_TWO");			break;
													case COQUILLAGE_HOME_THREE:			print(string, len, "COQUILLAGE_HOME_THREE");		break;
													case COQUILLAGE_HOME_FOUR:			print(string, len, "COQUILLAGE_HOME_FOUR");			break;
													case COQUILLAGE_HOME_FIVE:			print(string, len, "COQUILLAGE_HOME_FIVE");			break;
													case COQUILLAGE_HOME_ROCK_ONE:		print(string, len, "COQUILLAGE_HOME_ROCK_ONE");		break;
													case COQUILLAGE_HOME_ROCK_TWO:		print(string, len, "COQUILLAGE_HOME_ROCK_TWO");		break;
													case COQUILLAGE_HOME_ROCK_THREE:	print(string, len, "COQUILLAGE_HOME_ROCK_THREE");	break;
													case COQUILLAGE_NB:					print(string, len, "COQUILLAGE_NB");				break;
													case COQUILLAGES_ATTAQUE:			print(string, len, "COQUILLAGES_ATTAQUE");			break;
													case COQUILLAGES_DEFENSE:			print(string, len, "COQUILLAGES_DEFENSE");			break;
													case FIRST_DOOR_CLOSED:				print(string, len, "FIRST_DOOR_CLOSED");			break;
													case SECOND_DOOR_CLOSED:			print(string, len, "SECOND_DOOR_CLOSED");			break;
													case OUR_START_ZONE_BLOC_TAKEN:		print(string, len, "OUR_START_ZONE_BLOC_TAKEN");	break;
													case ADV_START_ZONE_BLOC_TAKEN:		print(string, len, "ADV_START_ZONE_BLOC_TAKEN");	break;
													case OUR_DUNE_BLOC_TAKEN:			print(string, len, "OUR_DUNE_BLOC_TAKEN");			break;
													case ADV_DUNE_BLOC_TAKEN:			print(string, len, "ADV_DUNE_BLOC_TAKEN");			break;
													case FISHS_TAKEN_BY_BLACK:			print(string, len, "FISHS_TAKEN_BY_BLACK");			break;
													case FISHS_TAKEN_BY_PEARL:			print(string, len, "FISHS_TAKEN_BY_PEARL");			break;
													case DUNE_TAKEN:					print(string, len, "DUNE_TAKEN");					break;
													case DUNE_IN_ROBOT:					print(string, len, "DUNE_IN_ROBOT");				break;
													case BLOC_DUNE_TRIED:				print(string, len, "BLOC_DUNE_TRIED");				break;
													case BLOC_START_ZONE_TRIED:			print(string, len, "BLOC_START_ZONE_TRIED");		break;
													case OUR_BLOC_PRESENT:				print(string, len, "OUR_BLOC_PRESENT");				break;
													case OUR_BLOC_ABSENT:				print(string, len, "OUR_BLOC_ABSENT");				break;
													case ADV_BLOC_PRESENT:				print(string, len, "ADV_BLOC_PRESENT");				break;
													case ADV_BLOC_ABSENT:				print(string, len, "ADV_BLOC_ABSENT");				break;
													case APOCALYPSE_SCAN:				print(string, len, "APOCALYPSE_SCAN");				break;
													case APOCALYPSE_TAKEN:				print(string, len, "APOCALYPSE_TAKEN");				break;
													case APOCALYPSE_SECOND_PART:		print(string, len, "APOCALYPSE_SECOND_PART");		break;
													case APOCALYPSE_WTF:				print(string, len, "APOCALYPSE_WTF");				break;
													case APOCALYPSE_TOTAL_DUNE:			print(string, len, "APOCALYPSE_TOTAL_DUNE");		break;
													case APOCALYPSE_ABSENT:				print(string, len, "APOCALYPSE_ABSENT");			break;
													case DEPOSE_BLOC_ERROR:				print(string, len, "DEPOSE_BLOC_ERROR");			break;
													case DEPOSE_BLOC_DOUBLE_ERROR:		print(string, len, "DEPOSE_BLOC_DOUBLE_ERROR");		break;
													case DEPOSE_POS_0:					print(string, len, "DEPOSE_POS_0");					break;
													case DEPOSE_POS_1:					print(string, len, "DEPOSE_POS_1");					break;
													case DEPOSE_POS_2:					print(string, len, "DEPOSE_POS_2");					break;
													case DEPOSE_POS_3:					print(string, len, "DEPOSE_POS_3");					break;
													case BLACK_LET_PEARL_GO_TAKE_DUNE_BLOC:	print(string, len, "BLACK_LET_PEARL_GO_TAKE_DUNE_BLOC");	break;
													case BLACK_CAN_USE_DUNIX:			print(string, len, "BLACK_CAN_USE_DUNIX");			break;
													case BLACK_TRY_DOORS:				print(string, len, "BLACK_TRY_DOORS");				break;
													case BLACK_DOORS:					print(string, len, "BLACK_DOORS");					break;
													case BLACK_OUR_BLOC_DUNE:			print(string, len, "BLACK_OUR_BLOC_DUNE");			break;
													case BLACK_IN_APOCALYPSE:			print(string, len, "BLACK_IN_APOCALYPSE");			break;
													case BLACK_ADV_BLOC_DUNE:			print(string, len, "BLACK_ADV_BLOC_DUNE");			break;
													case BLACK_OUR_START_ZONE:			print(string, len, "BLACK_OUR_START_ZONE");			break;
													case BLACK_DEPOSE_SAND:				print(string, len, "BLACK_DEPOSE_SAND");			break;
													case BLACK_ADV_START_ZONE:			print(string, len, "BLACK_ADV_START_ZONE");			break;
													case BLACK_DEPOSE_SEASHELL:			print(string, len, "BLACK_DEPOSE_SEASHELL");		break;
													case BLACK_PUSH_SEASHELL:			print(string, len, "BLACK_PUSH_SEASHELL");			break;
													case BLACK_IN_SNOWPLOW:				print(string, len, "BLACK_IN_SNOWPLOW");			break;
													case BLACK_FISH:					print(string, len, "BLACK_FISH");					break;
													case BLACK_CATCH_SEASHELL:			print(string, len, "BLACK_CATCH_SEASHELL");			break;
													case PEARL_CAN_START_MATCH:			print(string, len, "PEARL_CAN_START_MATCH");		break;
													case PEARL_DOORS:					print(string, len, "PEARL_DOORS");					break;
													case PEARL_OUR_BLOC_DUNE:			print(string, len, "PEARL_OUR_BLOC_DUNE");			break;
													case PEARL_ADV_BLOC_DUNE:			print(string, len, "PEARL_ADV_BLOC_DUNE");			break;
													case PEARL_OUR_START_ZONE:			print(string, len, "PEARL_OUR_START_ZONE");			break;
													case PEARL_DEPOSE_SAND:				print(string, len, "PEARL_DEPOSE_SAND");			break;
													case PEARL_ADV_START_ZONE:			print(string, len, "PEARL_ADV_START_ZONE");			break;
													case PEARL_DEPOSE_SEASHELL:			print(string, len, "PEARL_DEPOSE_SEASHELL");		break;
													case PEARL_OUR_SEASHELL:			print(string, len, "PEARL_OUR_SEASHELL");			break;
													case PEARL_ADV_SEASHELL:			print(string, len, "PEARL_ADV_SEASHELL");			break;
													case PEARL_CAN_GO_CLOSE_DOORS:		print(string, len, "PEARL_CAN_GO_CLOSE_DOORS");		break;
													case PEARL_FISH:					print(string, len, "PEARL_FISH");					break;
