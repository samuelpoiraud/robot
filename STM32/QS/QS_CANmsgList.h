 ...
 */
	...
	*/
	...
	#define DEBUG_PROPULSION_SET_ACCELERATION						0x713		//Data sur 16 bits. (unité : mm/4096/5ms/5ms) Grandeur typique : 100
		...
		//Si data[0] et data[1] sont à 0 -> retour à l'accélération par défaut.
...
typedef enum { //SEUL les SID des actionneurs doivent être mis comme enum, le reste en #DEFINE
	...
	ACT_CLAP = (ACT_FILTER | 0x33),
		...
		#define ACT_CLAP_TAKE_CUP					0x13
		#define ACT_CLAP_STOP						0x14
		#define ACT_CLAP_POP_CORN					0x15
	...
	ACT_POP_DROP_LEFT_WOOD = (ACT_FILTER | 0x40),
		...
		#define ACT_POP_DROP_LEFT_WOOD_MID			0x14
	...
	ACT_POP_DROP_RIGHT_WOOD = (ACT_FILTER | 0x41),
		...
		#define ACT_POP_DROP_RIGHT_WOOD_MID_POS		0x14

	///////////////POMPE WOOD/////////////////
	ACT_POMPE_WOOD = (ACT_FILTER | 0x42)
		#define ACT_POMPE_WOOD_NORMAL		0x11
		#define ACT_POMPE_WOOD_REVERSE		0x12
		#define ACT_POMPE_WOOD_STOP			0x13
