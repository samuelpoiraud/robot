...
#include "QS_apds9960.h"
	 ...
	 */
	void wireWriteByte(uint8_t val) {
		I2C_Write(APDS9960_I2C, APDS9960_I2C_ADDR << 1, NULL, 0, &val, 1);
	}
	 ...
	 */
	void wireWriteDataByte(uint8_t reg, uint8_t val) {
		I2C_Write(APDS9960_I2C, APDS9960_I2C_ADDR << 1, &reg, 1, &val, 1);
	}
	 ...
	 */
	void wireWriteDataBlock(uint8_t reg, uint8_t *val, unsigned int len) {
		I2C_Write(APDS9960_I2C, APDS9960_I2C_ADDR << 1, &reg, 1, val, len);
	}
	 ...
	 */
	void wireReadDataByte(uint8_t reg, uint8_t *val) {
		I2C_Read(APDS9960_I2C, APDS9960_I2C_ADDR << 1, &reg, 1, val, 1);
	}
