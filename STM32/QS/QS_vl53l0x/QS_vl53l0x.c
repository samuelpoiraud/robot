#include "QS_vl53l0x.h"
	...
	static volatile VL53L0X_sensor_t sensors[DISTANCE_SENSOR_NB_SENSOR] = {
			...
			{	.setAddress = 0x58, .rangeConfig = VL53L0X_HIGH_ACCURACY, .deviceMode = VL53L0X_DEVICEMODE_CONTINUOUS_RANGING, .GPIOx = CS_LASER_RIGHT_PORT, .GPIO_Pin = CS_LASER_RIGHT_PIN}	// DISTANCE_SENSOR_SMALL_RIGHT
	};
