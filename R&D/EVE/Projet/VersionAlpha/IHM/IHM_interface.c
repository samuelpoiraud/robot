...
GtkWidget* create_Fenetre (void)
{
  ...
  GTK_WIDGET_UNSET_FLAGS (can_zt_main, GTK_CAN_FOCUS);
 gtk_text_view_set_cursor_visible (GTK_TEXT_VIEW (can_zt_main), FALSE);
  gtk_text_view_set_editable (GTK_TEXT_VIEW (can_zt_main), FALSE);
  ...
  /************* Definition des emplacements des DATA ***************/
  ...
  g_signal_connect ((gpointer) can_send_button_send, "clicked",
                    ...
                    NULL);
g_signal_connect ((gpointer) cei_ong_all, "switch_page",
                    G_CALLBACK (on_cei_ong_all_switch_page),
                    NULL);
  ...
  g_signal_connect ((gpointer) cei_act_button_bt1, "pressed",
                    G_CALLBACK (on_cei_act_button_bt1_pressed),
                    NULL);
  g_signal_connect ((gpointer) cei_act_button_bt2, "pressed",
                    G_CALLBACK (on_cei_act_button_bt2_pressed),
                    NULL);
  g_signal_connect ((gpointer) cei_act_button_bt3, "pressed",
                    G_CALLBACK (on_cei_act_button_bt3_pressed),
                    NULL);
  g_signal_connect ((gpointer) cei_act_button_bt4, "pressed",
                    G_CALLBACK (on_cei_act_button_bt4_pressed),
                    NULL);
  g_signal_connect ((gpointer) cei_act_button_reset, "pressed",
                    G_CALLBACK (on_cei_act_button_reset_pressed),
                    NULL);
  g_signal_connect ((gpointer) cei_pro_button_bt1, "pressed",
                    G_CALLBACK (on_cei_pro_button_bt1_pressed),
                    NULL);
  g_signal_connect ((gpointer) cei_pro_button_bt2, "pressed",
                    G_CALLBACK (on_cei_pro_button_bt2_pressed),
                    NULL);
  g_signal_connect ((gpointer) cei_pro_button_bt3, "pressed",
                    G_CALLBACK (on_cei_pro_button_bt3_pressed),
                    NULL);
  g_signal_connect ((gpointer) cei_pro_button_bt4, "pressed",
                    G_CALLBACK (on_cei_pro_button_bt4_pressed),
                    NULL);
  g_signal_connect ((gpointer) button158, "pressed",
                    G_CALLBACK (on_cei_pro_button_reset_pressed),
                    NULL);
  g_signal_connect ((gpointer) cei_stra_button_bt1, "pressed",
                    G_CALLBACK (on_cei_stra_button_bt1_pressed),
                    NULL);
  g_signal_connect ((gpointer) button165, "pressed",
                    G_CALLBACK (on_cei_stra_button_bt2_pressed),
                    NULL);
  g_signal_connect ((gpointer) cei_stra_button_bt3, "pressed",
                    G_CALLBACK (on_cei_stra_button_bt3_pressed),
                    NULL);
  g_signal_connect ((gpointer) cei_stra_button_bt4, "pressed",
                    G_CALLBACK (on_cei_stra_button_bt4_pressed),
                    NULL);
  g_signal_connect ((gpointer) cei_stra_button_reset, "pressed",
                    G_CALLBACK (on_cei_stra_button_reset_pressed),
                    NULL);
  g_signal_connect ((gpointer) cei_sup_button_bt1, "pressed",
                    G_CALLBACK (on_cei_sup_button_bt1_pressed),
                    NULL);
  g_signal_connect ((gpointer) cei_sup_button_bt2, "pressed",
                    G_CALLBACK (on_cei_sup_button_bt2_pressed),
                    NULL);
  g_signal_connect ((gpointer) button176, "pressed",
                    G_CALLBACK (on_cei_sup_button_bt3_pressed),
                    NULL);
  g_signal_connect ((gpointer) button177, "pressed",
                    G_CALLBACK (on_cei_sup_button_bt4_pressed),
                    NULL);
  g_signal_connect ((gpointer) button178, "pressed",
                    G_CALLBACK (on_cei_sup_button_reset_pressed),
                    NULL);
  g_signal_connect ((gpointer) button185, "pressed",
                    G_CALLBACK (on_cei_act_button_bt2_pressed),
                    NULL);
  g_signal_connect ((gpointer) button186, "pressed",
                    G_CALLBACK (on_cei_act_button_bt3_pressed),
                    NULL);
  g_signal_connect ((gpointer) button187, "pressed",
                    G_CALLBACK (on_cei_act_button_bt4_pressed),
                    NULL);
  g_signal_connect ((gpointer) button188, "pressed",
                    G_CALLBACK (on_cei_act_button_reset_pressed),
                    NULL);

  g_signal_connect((gpointer)Fenetre, "destroy", G_CALLBACK(on_quitter1_activate), NULL);

  g_signal_connect ((gpointer) cei_act_button_bt1, "released",
                    G_CALLBACK (on_cei_act_button_bt1_released),
                    NULL);
  g_signal_connect ((gpointer) cei_act_button_bt2, "released",
                    G_CALLBACK (on_cei_act_button_bt2_released),
                    NULL);
  g_signal_connect ((gpointer) cei_act_button_bt3, "released",
                    G_CALLBACK (on_cei_act_button_bt3_released),
                    NULL);
  g_signal_connect ((gpointer) cei_act_button_bt4, "released",
                    G_CALLBACK (on_cei_act_button_bt4_released),
                    NULL);
  g_signal_connect ((gpointer) cei_act_button_reset, "released",
                    G_CALLBACK (on_cei_act_button_reset_released),
                    NULL);
  g_signal_connect ((gpointer) cei_pro_button_bt1, "released",
                    G_CALLBACK (on_cei_pro_button_bt1_released),
                    NULL);
  g_signal_connect ((gpointer) cei_pro_button_bt2, "released",
                    G_CALLBACK (on_cei_pro_button_bt2_released),
                    NULL);
  g_signal_connect ((gpointer) cei_pro_button_bt3, "released",
                    G_CALLBACK (on_cei_pro_button_bt3_released),
                    NULL);
  g_signal_connect ((gpointer) cei_pro_button_bt4, "released",
                    G_CALLBACK (on_cei_pro_button_bt4_released),
                    NULL);
  g_signal_connect ((gpointer) button158, "released",
                    G_CALLBACK (on_cei_pro_button_reset_released),
                    NULL);
  g_signal_connect ((gpointer) cei_stra_button_bt1, "released",
                    G_CALLBACK (on_cei_stra_button_bt1_released),
                    NULL);
  g_signal_connect ((gpointer) button165, "released",
                    G_CALLBACK (on_cei_stra_button_bt2_released),
                    NULL);
  g_signal_connect ((gpointer) cei_stra_button_bt3, "released",
                    G_CALLBACK (on_cei_stra_button_bt3_released),
                    NULL);
  g_signal_connect ((gpointer) cei_stra_button_bt4, "released",
                    G_CALLBACK (on_cei_stra_button_bt4_released),
                    NULL);
  g_signal_connect ((gpointer) cei_stra_button_reset, "released",
                    G_CALLBACK (on_cei_stra_button_reset_released),
                    NULL);
  g_signal_connect ((gpointer) cei_sup_button_bt1, "released",
                    G_CALLBACK (on_cei_sup_button_bt1_released),
                    NULL);
  g_signal_connect ((gpointer) cei_sup_button_bt2, "released",
                    G_CALLBACK (on_cei_sup_button_bt2_released),
                    NULL);
  g_signal_connect ((gpointer) button176, "released",
                    G_CALLBACK (on_cei_sup_button_bt3_released),
                    NULL);
  g_signal_connect ((gpointer) button177, "released",
                    G_CALLBACK (on_cei_sup_button_bt4_released),
                    NULL);
  g_signal_connect ((gpointer) button178, "released",
                    G_CALLBACK (on_cei_sup_button_reset_released),
                    NULL);
  g_signal_connect ((gpointer) button185, "released",
                    G_CALLBACK (on_cei_act_button_bt2_released),
                    NULL);
  g_signal_connect ((gpointer) button186, "released",
                    G_CALLBACK (on_cei_act_button_bt3_released),
                    NULL);
  g_signal_connect ((gpointer) button187, "released",
                    G_CALLBACK (on_cei_act_button_bt4_released),
                    NULL);
  g_signal_connect ((gpointer) button188, "released",
                    G_CALLBACK (on_cei_act_button_reset_released),
                    NULL);
