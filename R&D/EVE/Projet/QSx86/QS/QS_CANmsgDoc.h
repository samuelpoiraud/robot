 ...
 *	Package : QSx86
 *	Description : Documentation des messages CAN
	...
	#define CARTE_P_POSITION_ROBOT
		...
		Raison : Uint8 (Raison de l'envoi du Broadcast... s'agit-il d'un avertisseur ? d'un envoi périodique ? sur simple demande ?...)
			Remarque : Il est possible de CUMULER plusieurs raisons !!!
				#define DEMANDE_ENVOI_PAS_DE_DEMANDE			(0b00000000)
				#define DEMANDE_ENVOI_PAR_TEMPS_ECOULE			(0b00000001)
				#define DEMANDE_ENVOI_PAR_TRANSLATION			(0b00000010)
				#define DEMANDE_ENVOI_PAR_ROTATION				(0b00000100)
				#define DEMANDE_ENVOI_PAR_ATTEINTE_X			(0b00001000)
				#define DEMANDE_ENVOI_PAR_ATTEINTE_Y			(0b00010000)
				#define DEMANDE_ENVOI_PAR_ATTEINTE_TETA			(0b00100000)
				#define DEMANDE_ENVOI_PAR_ROBOT_CHANGE_POINT	(0b01000000)
				#define DEMANDE_ENVOI_PAR_ROBOT_FREINE 			(0b10000000)
	*/
