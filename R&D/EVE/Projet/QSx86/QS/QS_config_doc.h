 ...
 *	Logiciel EVE
 *
 *	Fichier : QS_config_doc.c
 *	Package : QSx86
 *	Description : Liste des configurations des modules QS
 ...
 */
	...
	#define FREQ_10MHZ
//	#define FREQ_INTERNAL_CLK	/* uniquement pour tester sans utiliser le quartz */
//	#define FREQ_20MHZ
//	#define FREQ_40MHZ
...
//	#define SERVO9
	...
	/* gestion de codeur sur IT */
	/* déclarer l'utilisation du pilote */
	#define USE_QEI_ON_IT
	/* IT externes recevant les signaux des codeurs (0, 1, 2, 3 ou 4) */
	...
	/* nombre de seromoteurs sur le même bus UART */
	#define AX12_NUMBER 1
	/* port du PIC dédié à la gestion de l'UART en half-duplex (un seul fil de Data) */
	#define DIRECTION_PORT LATBbits.LATBX
