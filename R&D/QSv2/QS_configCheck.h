 ...
 */
	...
	#if !(defined(TEST_MODE) || defined(MATCH_MODE))
		#error "Un mode de fonctionnement doit être sélectionné"
	#endif

	#if !(defined(FREQ_10MHZ) || defined(FREQ_10MHZ_FS_CLK) || defined(FREQ_20MHZ) || defined(FREQ_40MHZ))
