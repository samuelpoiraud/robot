 ...
 */
	...
	#define QS_CONFIGBITS_H
		...
		#elif defined(FREQ_10MHZ_FS_CLK)
			_FOSC(CSW_FSCM_OFF & XT_PLL4) /* XT PLL x4 & Failsafe clock on */
		...
		#else
			// oscillateur interne 7.74MHz, interdit au robot, non supporté par la QS */
			_FOSC(CSW_FSCM_OFF & FRC_PLL4) /* Interne PLL x4 & Failsafe clock off */
