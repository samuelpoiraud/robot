...
#define OFFSET_ANGLE			0		//(-PI4096/2 pour 2014) : l'angle 0 est orienté vers la droite... c'est malin !
...
error_t BRAIN_find_distance(Uint8 i)
{
	...
	if(power < 80){
		...
		distance = (((Sint32)395*(Sint32)power*(Sint32)power - (Sint32)70813*(Sint32)power + (Sint32)3680870) >> 10)/20 - 5;
		...
		//distance = ((-(Sint32)13854*(Sint32)power + (Sint32)1782579) >> 10)/20;  //2016
