...
typedef enum {
	ACT_AVOID_POP_COLLECT_LEFT_Lock,
	ACT_AVOID_POP_COLLECT_LEFT_Unlock
} ACT_AVOID_POP_COLLECT_LEFT_CMD;

typedef enum {
	ACT_AVOID_POP_COLLECT_RIGHT_Lock,
	ACT_AVOID_POP_COLLECT_RIGHT_Unlock
} ACT_AVOID_POP_COLLECT_RIGHT_CMD;

typedef enum {
	ACT_AVOID_POP_DROP_LEFT_Lock,
	ACT_AVOID_POP_DROP_LEFT_Unlock
} ACT_AVOID_POP_DROP_LEFT_CMD;

typedef enum {
	ACT_AVOID_POP_DROP_RIGHT_Lock,
	ACT_AVOID_POP_DROP_RIGHT_Unlock
