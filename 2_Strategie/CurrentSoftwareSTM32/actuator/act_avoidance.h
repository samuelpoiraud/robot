...
typedef enum {
	ACT_AVOID_SMALL_CYLINDER_POUSSIX_Down
}ACT_AVOID_SMALL_CYLINDER_POUSSIX_CMD;
/*
typedef enum {
	ACT_AVOID_SMALL_CYLINDER_MULTIFONCTION_pos1,
	ACT_AVOID_SMALL_CYLINDER_MULTIFONCTION_pos2,
	ACT_AVOID_SMALL_CYLINDER_MULTIFONCTION_pos3,
}ACT_AVOID_SMALL_CYLINDER_MULTIFONCTION_CMD;*/

/*
typedef enum {
	ACT_AVOID_SMALL_MAGIC_ARM_pos1
}ACT_AVOID_SMALL_MAGIC_ARM_CMD;*/
/*
typedef enum {
	ACT_AVOID_SMALL_ORE_pos1
}ACT_AVOID_SMALL_ORE_CMD;*/
