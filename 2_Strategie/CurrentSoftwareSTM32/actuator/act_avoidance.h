...
typedef enum {
	ACT_AVOID_POMPE_ACT_SLIDER_LEFT_Normal
}ACT_AVOID_POMPE_ACT_SLIDER_LEFT_CMD;

typedef enum {
	ACT_AVOID_POMPE_ACT_SLIDER_RIGHT_Normal
}ACT_AVOID_POMPE_ACT_SLIDER_RIGHT_CMD;

typedef enum {
	ACT_AVOID_POMPE_ACT_ELEVATOR_LEFT_Normal
}ACT_AVOID_POMPE_ACT_ELEVATOR_LEFT_CMD;

typedef enum {
	ACT_AVOID_POMPE_ACT_ELEVATOR_RIGHT_Normal
}ACT_AVOID_POMPE_ACT_ELEVATOR_RIGHT_CMD;
