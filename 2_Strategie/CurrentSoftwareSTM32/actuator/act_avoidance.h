...
typedef enum {
	...
	ACT_AVOID_FISH_UNSTICK_ARM_Up_Tapotage,
	ACT_AVOID_FISH_UNSTICK_ARM_Down_Tapotage,
...
typedef enum {
	...
	ACT_AVOID_FISH_MAGNETIC_ARM_Up_Tapotage,
	ACT_AVOID_FISH_MAGNETIC_ARM_Down_Tapotage,
	ACT_AVOID_FISH_MAGNETIC_ARM_Middle
}ACT_AVOID_FISH_MAGNETIC_ARM_CMD;
...
typedef enum {
	ACT_AVOID_SHOVEL_DUNE_CMD_Take,
	ACT_AVOID_SHOVEL_DUNE_CMD_Store,
	ACT_AVOID_SHOVEL_DUNE_CMD_Rescue
} ACT_AVOID_SHOVEL_DUNE_CMD;

typedef enum {
	ACT_AVOID_BRUSH_DUNE_CMD_Push_Mid,
	ACT_AVOID_BRUSH_DUNE_CMD_Push_All,
	ACT_AVOID_BRUSH_DUNE_CMD_Sucker_Release
} ACT_AVOID_BRUSH_DUNE_CMD;
