...
typedef enum {
	...
	ACT_carpet_launcher_left_loading = ACT_CARPET_LAUNCHER_LEFT_LOADING,
...
////////////////////////////////////////
typedef enum {
	ACT_pince_gauche_idle_pos = ACT_PINCE_GAUCHE_IDLE_POS,
...
typedef enum {
	...
	ACT_pop_drop_right_Wood_mid_pos = ACT_POP_DROP_RIGHT_WOOD_MID_POS,
