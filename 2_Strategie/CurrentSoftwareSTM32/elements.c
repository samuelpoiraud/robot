...
//		STOCKS_addModule(MODULE_BLUE, STOCK_POS_BALANCER, MODULE_STOCK_SMALL);
//		STOCKS_addModule(MODULE_BLUE, STOCK_POS_CONTAINER, MODULE_STOCK_SMALL);
//		STOCKS_addModule(MODULE_BLUE, STOCK_POS_SLOPE, MODULE_STOCK_SMALL);
//		STOCKS_addModule(MODULE_BLUE, STOCK_POS_COLOR, MODULE_STOCK_SMALL);
