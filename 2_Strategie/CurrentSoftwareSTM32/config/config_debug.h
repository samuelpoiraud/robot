...
#define OUTPUT_LOG_COMPONENT_PROP_FUNCTION			LOG_PRINT_On
#define OUTPUT_LOG_COMPONENT_DETECTION				LOG_PRINT_On
#define OUTPUT_LOG_COMPONENT_AVOIDANCE				LOG_PRINT_On
