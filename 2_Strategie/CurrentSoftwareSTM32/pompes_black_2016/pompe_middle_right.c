...
// Formatage : QUEUE_ACT_POMPE_MIDDLE_RIGHT
...
// Un define MIDDLE_RIGHT_PIN doit avoir été ajouté au fichier config_big/config_pin.h // config_small/config_pin.h
...
static void POMPE_MIDDLE_RIGHT_command(ACT_order_e command);
