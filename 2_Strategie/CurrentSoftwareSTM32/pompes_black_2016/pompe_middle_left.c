...
// Formatage : QUEUE_ACT_POMPE_MIDDLE_LEFT
...
// Un define MIDDLE_LEFT_PIN doit avoir été ajouté au fichier config_big/config_pin.h // config_small/config_pin.h
...
static void POMPE_MIDDLE_LEFT_command(ACT_order_e command);
