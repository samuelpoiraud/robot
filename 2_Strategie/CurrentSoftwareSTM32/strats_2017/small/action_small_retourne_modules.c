...
#define PUSH_BEFORE_TURN_DISABLE			0		//Si 1 : on désactive le poussage avant dépose.
...
#define FN_FN1			100					//Distance entre deux déposes de modules
...
error_e sub_anne_turn_modules_centre(moduleMoonbaseLocation_e moonbase, ELEMENTS_side_match_e basis_side)
{
	...
	static GEOMETRY_vector_t RA;	//vecteur RA (A=projeté de R sur l'axe de turn ou de push)
