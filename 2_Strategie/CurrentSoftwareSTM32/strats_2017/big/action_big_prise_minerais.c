...
error_e sub_harry_take_big_crater_yellow_middle(){
	...
	switch(state){
		...
		case COLLECT_YELLOW_MIDDLE_ACTIVATE:{
			...
			ACT_push_order(ACT_ORE_ROLLER,  ACT_ORE_ROLLER_DOWN);
			...
			state1= check_act_status(ACT_QUEUE_Ore_roller, state1, COLLECT_YELLOW_MIDDLE_MOVE_FOWARD, ERROR);
...
if((state1==ERROR)||(state2==ERROR)||(state3==ERROR)||(state4==ERROR)||(state5==ERROR)||(state6==ERROR)){
	...
	state=COLLECT_YELLOW_MIDDLE_MOVE_FOWARD;
		...
		case COLLECT_YELLOW_MIDDLE_VALIDATE:{
			...
			// remonter le rouleau
			ACT_push_order(ACT_ORE_ROLLER,  ACT_ORE_ROLLER_UP);
			//remonter les billes porteuses et descendre la roue
...
error_e sub_harry_take_big_crater_yellow_fuse(){
	...
	switch(state){
		...
		case COLLECT_YELLOW_FUSE_ACTIVATE:{
			...
			state1= check_act_status(ACT_QUEUE_Ore_roller, state1, COLLECT_YELLOW_FUSE_MOVE_FOWARD, ERROR);
...
//COLLECT_YELLOW_CORNER
	...
	switch(state){
		...
		case COLLECT_YELLOW_CORNER_ACTIVATE:{
			...
			state1= check_act_status(ACT_QUEUE_Ore_roller, state1, COLLECT_YELLOW_CORNER_MOVE_FOWARD, ERROR);
...
error_e sub_harry_take_big_crater_blue_middle(){
	...
	switch(state){
		...
		case COLLECT_BLUE_MIDDLE_ACTIVATE:{
			...
			state1= check_act_status(ACT_QUEUE_Ore_roller, state1, COLLECT_BLUE_MIDDLE_MOVE_FOWARD, ERROR);
...
error_e sub_harry_take_big_crater_blue_fuse(){
	...
	switch(state){
		...
		case COLLECT_BLUE_FUSE_ACTIVATE:{
			...
			state1= check_act_status(ACT_QUEUE_Ore_roller, state1, COLLECT_BLUE_FUSE_MOVE_FOWARD, ERROR);
...
error_e sub_harry_take_big_crater_blue_corner(){
	...
	switch(state){
		...
		case COLLECT_BLUE_CORNER_ACTIVATE:{
			...
			state1= check_act_status(ACT_QUEUE_Ore_roller, state1, COLLECT_BLUE_CORNER_MOVE_FOWARD, ERROR);
