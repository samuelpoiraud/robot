...
TYPEDEF_ENUM_WITH_STRING(subaction_id_e, subaction_name,
	...
	//--------------Sub action de Black
	SUB_BLACK_STRAT_INITIALE,
//	SUB_BLACK_TAKE_SAND_BLOC_NEXT_DUNE,
	SUB_BLACK_COLLECT_FISHS_1,
	SUB_BLACK_COLLECT_FISHS_2,
	SUB_BLACK_CLOSE_DOORS,
	SUB_BLACK_PUSH_SEASHELLS,
	SUB_BLACK_APOCALYPSE,
	SUB_BLACK_END_OF_MATCH,
	SUB_BLACK_SAND_DEPOSE,
	SUB_BLACK_OUR_DUNE_BLOC,
	SUB_BLACK_ADV_DUNE_BLOC,
	SUB_BLACK_OUR_START_ZONE_BLOC,
	SUB_BLACK_ADV_START_ZONE_BLOC,
	SUB_BLACK_WAIT_ONE_SEC,
	SUB_BLACK_RETURN_TAKE_DUNE,

	//--------------Sub action de Pearl
	SUB_PEARL_STRAT_INITIALE,
	SUB_PEARL_OUR_DUNE_BLOC,
	SUB_PEARL_ADV_DUNE_BLOC,
	SUB_PEARL_OUR_START_ZONE_BLOC,
	SUB_PEARL_ADV_START_ZONE_BLOC,
	SUB_PEARL_CLOSE_DOORS,
	SUB_PEARL_COQUILLAGES_CLOSE,
	SUB_PEARL_COQUILLAGES_MIDDLE,
	SUB_PEARL_ATTAQUE,
	SUB_PEARL_END_OF_MATCH,
	SUB_PEARL_SAND_DEPOSE,
	SUB_PEARL_WAIT_NORTH,
	SUB_PEARL_WAIT_ONE_SEC,
	SUB_PEARL_COLLECT_FISHS,
