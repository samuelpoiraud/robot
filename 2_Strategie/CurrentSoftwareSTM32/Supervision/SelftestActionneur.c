...
error_e SELFTESTACT_run(){
	...
	static const struct_selftest_t tableau_selftest_big[]  = {
			...
			{17, ACT_CYLINDER_BALANCER_RIGHT,	 ACT_CYLINDER_BALANCER_RIGHT_IN,	 	0,		ACT_QUEUE_Cylinder_balancer_right,		SELFTEST_ACT_AX12_CYLINDER_BALANCER_RIGHT	},
			{18, ACT_CYLINDER_BALANCER_RIGHT,	 ACT_CYLINDER_BALANCER_RIGHT_OUT,		0,		ACT_QUEUE_Cylinder_balancer_right,		SELFTEST_ACT_AX12_CYLINDER_BALANCER_RIGHT	},
			{19, ACT_CYLINDER_COLOR_RIGHT,		 ACT_CYLINDER_COLOR_RIGHT_NORMAL_SPEED,	0,		ACT_QUEUE_Cylinder_color_right,			SELFTEST_ACT_RX24_CYLINDER_COLOR_RIGHT 		},
			{20, ACT_CYLINDER_COLOR_RIGHT,		 ACT_CYLINDER_COLOR_RIGHT_ZERO_SPEED,	0,		ACT_QUEUE_Cylinder_color_right,			SELFTEST_ACT_RX24_CYLINDER_COLOR_RIGHT		},
			{21, ACT_CYLINDER_ARM_RIGHT,		 ACT_CYLINDER_ARM_RIGHT_OUT,			0,		ACT_QUEUE_Cylinder_arm_right,			SELFTEST_ACT_RX24_CYLINDER_ARM_RIGHT		},
			{22, ACT_CYLINDER_DISPOSE_RIGHT,	 ACT_CYLINDER_DISPOSE_RIGHT_TAKE,		0,		ACT_QUEUE_Cylinder_dispose_right,		SELFTEST_ACT_AX12_CYLINDER_DISPOSE_RIGHT	},
			{22, ACT_POMPE_DISPOSE_RIGHT,		 ACT_POMPE_NORMAL,						0,		ACT_QUEUE_Pompe_act_dispose_right,		SELFTEST_ACT_POMPE_DISPOSE_RIGHT			},
			{23, ACT_CYLINDER_DISPOSE_RIGHT,	 ACT_CYLINDER_DISPOSE_RIGHT_DISPOSE,	0,		ACT_QUEUE_Cylinder_dispose_right,		SELFTEST_ACT_AX12_CYLINDER_DISPOSE_RIGHT	},
			{24, ACT_CYLINDER_DISPOSE_RIGHT,	 ACT_CYLINDER_DISPOSE_RIGHT_IDLE,		0,		ACT_QUEUE_Cylinder_dispose_right,		SELFTEST_ACT_AX12_CYLINDER_DISPOSE_RIGHT	},
			{24, ACT_POMPE_DISPOSE_RIGHT,		 ACT_POMPE_STOP,						0,		ACT_QUEUE_Pompe_act_dispose_right,		SELFTEST_ACT_POMPE_DISPOSE_RIGHT			},
			...
			{28, ACT_CYLINDER_BALANCER_LEFT,	 ACT_CYLINDER_BALANCER_LEFT_IN,			0,		ACT_QUEUE_Cylinder_balancer_left,		SELFTEST_ACT_AX12_CYLINDER_BALANCER_LEFT	},
			{29, ACT_CYLINDER_BALANCER_LEFT,	 ACT_CYLINDER_BALANCER_LEFT_OUT,		0,		ACT_QUEUE_Cylinder_balancer_left,		SELFTEST_ACT_AX12_CYLINDER_BALANCER_LEFT	},
			{30, ACT_CYLINDER_COLOR_LEFT,		 ACT_CYLINDER_COLOR_LEFT_NORMAL_SPEED,	0,		ACT_QUEUE_Cylinder_color_left,			SELFTEST_ACT_RX24_CYLINDER_COLOR_LEFT		},
			{31, ACT_CYLINDER_COLOR_LEFT,		 ACT_CYLINDER_COLOR_LEFT_ZERO_SPEED,	0,		ACT_QUEUE_Cylinder_color_left,			SELFTEST_ACT_RX24_CYLINDER_COLOR_LEFT		},
			{32, ACT_CYLINDER_ARM_LEFT,			 ACT_CYLINDER_ARM_LEFT_OUT,			 	0,		ACT_QUEUE_Cylinder_arm_left,			SELFTEST_ACT_RX24_CYLINDER_ARM_LEFT			},
			{33, ACT_CYLINDER_DISPOSE_LEFT,		 ACT_CYLINDER_DISPOSE_LEFT_TAKE,		0,		ACT_QUEUE_Cylinder_dispose_left,		SELFTEST_ACT_AX12_CYLINDER_DISPOSE_LEFT		},
			{33, ACT_POMPE_DISPOSE_LEFT,		 ACT_POMPE_NORMAL,						0,		ACT_QUEUE_Pompe_act_dispose_left,		SELFTEST_ACT_POMPE_DISPOSE_LEFT				},
			{34, ACT_CYLINDER_DISPOSE_LEFT,		 ACT_CYLINDER_DISPOSE_LEFT_DISPOSE,		0,		ACT_QUEUE_Cylinder_dispose_left,		SELFTEST_ACT_AX12_CYLINDER_DISPOSE_LEFT		},
			{35, ACT_CYLINDER_DISPOSE_LEFT,		 ACT_CYLINDER_DISPOSE_LEFT_IDLE,		0,		ACT_QUEUE_Cylinder_dispose_left,		SELFTEST_ACT_AX12_CYLINDER_DISPOSE_LEFT		},
			{35, ACT_POMPE_DISPOSE_LEFT,		 ACT_POMPE_STOP,						0,		ACT_QUEUE_Pompe_act_dispose_left,		SELFTEST_ACT_POMPE_DISPOSE_LEFT				},
			...
			{43, ACT_ORE_WALL,	 				ACT_ORE_WALL_OUT,						0,							ACT_QUEUE_Ore_wall,						SELFTEST_ACT_RX24_ORE_WALL },
			{44, ACT_ORE_ROLLER_ARM,	 		ACT_ORE_ROLLER_ARM_OUT,				 	0,							ACT_QUEUE_Ore_roller_arm,				SELFTEST_ACT_RX24_ORE_ROLLER_ARM },
			{45, ACT_ORE_ROLLER_FOAM,	 		ACT_ORE_ROLLER_FOAM_RUN,				ACT_ROLLER_FOAM_SPEED_RUN,	ACT_QUEUE_Ore_roller_foam,				SELFTEST_ACT_RX24_ORE_FOAM },
			{46, ACT_ORE_TRIHOLE,	 			ACT_ORE_TRIHOLE_RUN,					ACT_TRIHOLE_SPEED_RUN,		ACT_QUEUE_Ore_trihole,					SELFTEST_ACT_RX24_ORE_TRIHOLE },
			{47, ACT_BEARING_BALL_WHEEL,	 	ACT_BEARING_BALL_WHEEL_UP,		 		0,							ACT_QUEUE_Bearing_ball_wheel, 			SELFTEST_ACT_AX12_BEARING_BALL_WHEEL },
			{48, ACT_BEARING_BALL_WHEEL,	 	ACT_BEARING_BALL_WHEEL_DOWN,	 		0,							ACT_QUEUE_Bearing_ball_wheel, 			SELFTEST_ACT_AX12_BEARING_BALL_WHEEL },
			{49, ACT_ORE_ROLLER_FOAM,	 		ACT_ORE_ROLLER_FOAM_STOP,				0,							ACT_QUEUE_Ore_roller_foam,				SELFTEST_ACT_RX24_ORE_FOAM },
			{50, ACT_ORE_TRIHOLE,	 			ACT_ORE_TRIHOLE_STOP,					0,							ACT_QUEUE_Ore_trihole,					SELFTEST_ACT_RX24_ORE_TRIHOLE },
			{51, ACT_ORE_ROLLER_ARM,	 		ACT_ORE_ROLLER_ARM_IN,					0,							ACT_QUEUE_Ore_roller_arm,				SELFTEST_ACT_RX24_ORE_ROLLER_ARM },
			{52, ACT_ORE_TRIHOLE,	 			ACT_ORE_TRIHOLE_STOP,					0,							ACT_QUEUE_Ore_trihole,					SELFTEST_ACT_RX24_ORE_TRIHOLE },
			{53, ACT_ORE_WALL,	 				ACT_ORE_WALL_IN,						0,							ACT_QUEUE_Ore_wall,						SELFTEST_ACT_RX24_ORE_WALL },
			{54, ACT_ORE_GUN,	 				ACT_ORE_GUN_DOWN,						0,							ACT_QUEUE_Ore_gun,						SELFTEST_ACT_RX24_ORE_GUN },
			{54, ACT_TURBINE,	 				ACT_MOSFET_NORMAL,						0,							ACT_QUEUE_Turbine,						SELFTEST_ACT_TURBINE },
			{55, ACT_ORE_GUN,	 				ACT_ORE_GUN_UP,						 	0,							ACT_QUEUE_Ore_gun,						SELFTEST_ACT_RX24_ORE_GUN },
			{55, ACT_TURBINE,	 				ACT_MOSFET_STOP,						0,							ACT_QUEUE_Turbine,						SELFTEST_ACT_TURBINE },
