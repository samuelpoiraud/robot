...
error_e SELFTESTACT_run(){
	...
	static const struct_selftest_t tableau_selftest_big[]  = {
			...
			{23, ACT_CYLINDER_BALANCER_RIGHT,	 ACT_CYLINDER_BALANCER_RIGHT_IN,	 	0,		ACT_QUEUE_Cylinder_balancer_right,		SELFTEST_ACT_AX12_CYLINDER_BALANCER_RIGHT	},
			...
			{34, ACT_CYLINDER_BALANCER_LEFT,	 ACT_CYLINDER_BALANCER_LEFT_IN,			0,		ACT_QUEUE_Cylinder_balancer_left,		SELFTEST_ACT_AX12_CYLINDER_BALANCER_LEFT	},
			...
			{39, ACT_TURBINE,	 				ACT_TURBINE_NORMAL,						0,							ACT_QUEUE_Turbine,						SELFTEST_ACT_TURBINE },
			{39, ACT_ORE_TRIHOLE,	 			ACT_ORE_TRIHOLE_RUN,					ACT_TRIHOLE_SPEED_RUN,		ACT_QUEUE_Ore_trihole,					SELFTEST_ACT_RX24_ORE_TRIHOLE },
			{40, ACT_ORE_GUN,	 				ACT_ORE_GUN_DOWN,						0,							ACT_QUEUE_Ore_gun,						SELFTEST_ACT_RX24_ORE_GUN },

			// Billes porteuses
			{41, ACT_BIG_BALL_BACK_LEFT,	 	ACT_BIG_BALL_BACK_LEFT_UP,		 		0,							ACT_QUEUE_Big_bearing_back_left, 		SELFTEST_ACT_AX12_BIG_BALL_BACK_LEFT },
			{42, ACT_BIG_BALL_BACK_LEFT,	 	ACT_BIG_BALL_BACK_LEFT_DOWN,	 		0,							ACT_QUEUE_Big_bearing_back_left, 		SELFTEST_ACT_AX12_BIG_BALL_BACK_LEFT },
			{43, ACT_BIG_BALL_BACK_RIGHT,	 	ACT_BIG_BALL_BACK_RIGHT_UP,		 		0,							ACT_QUEUE_Big_bearing_back_right, 		SELFTEST_ACT_AX12_BIG_BALL_BACK_RIGHT },
			{44, ACT_BIG_BALL_BACK_RIGHT,	 	ACT_BIG_BALL_BACK_RIGHT_DOWN,	 		0,							ACT_QUEUE_Big_bearing_back_right, 		SELFTEST_ACT_AX12_BIG_BALL_BACK_RIGHT },
			...
			{46, ACT_BEARING_BALL_WHEEL,	 	ACT_BEARING_BALL_WHEEL_DOWN,		 	0,							ACT_QUEUE_Bearing_ball_wheel, 			SELFTEST_ACT_AX12_BEARING_BALL_WHEEL },
			{47, ACT_BEARING_BALL_WHEEL,	 	ACT_BEARING_BALL_WHEEL_IDLE, 			0,							ACT_QUEUE_Bearing_ball_wheel, 			SELFTEST_ACT_AX12_BEARING_BALL_WHEEL },
			...
			{51, ACT_ORE_WALL,	 				ACT_ORE_WALL_IN,						0,							ACT_QUEUE_Ore_wall,						SELFTEST_ACT_RX24_ORE_WALL },
			...
			{53, ACT_ORE_ROLLER_ARM,	 		ACT_ORE_ROLLER_ARM_IN,					0,							ACT_QUEUE_Ore_roller_arm,				SELFTEST_ACT_RX24_ORE_ROLLER_ARM },
		};
	#endif
	...
	static const struct_selftest_t tableau_selftest_small[]  = {
			...
			{9, ACT_SMALL_POMPE_DISPOSE, 		ACT_POMPE_SMALL_SLIDER_NORMAL,		 	100,	ACT_QUEUE_Small_pompe_prise, 			SELFTEST_ACT_AX12_SMALL_POMPE_PRISE },
			...
			{11, ACT_SMALL_CYLINDER_ELEVATOR,	ACT_SMALL_CYLINDER_ELEVATOR_TOP,		0,		ACT_QUEUE_Small_cylinder_elevator, 		SELFTEST_ACT_AX12_SMALL_CYLINDER_ELEVATOR },
			{12, ACT_SMALL_CYLINDER_ELEVATOR,	ACT_SMALL_CYLINDER_ELEVATOR_BOTTOM,		0,		ACT_QUEUE_Small_cylinder_elevator, 		SELFTEST_ACT_AX12_SMALL_CYLINDER_ELEVATOR },
			...
			{15, ACT_SMALL_CYLINDER_COLOR,		ACT_SMALL_CYLINDER_COLOR_NORMAL_SPEED,	0,		ACT_QUEUE_Small_cylinder_color, 		SELFTEST_ACT_AX12_SMALL_CYLINDER_COLOR },
			{16, ACT_SMALL_CYLINDER_COLOR,		ACT_SMALL_CYLINDER_COLOR_ZERO_SPEED,	0,		ACT_QUEUE_Small_cylinder_color, 		SELFTEST_ACT_AX12_SMALL_CYLINDER_COLOR },

			{17, ACT_SMALL_CYLINDER_MULTIFONCTION,	ACT_SMALL_CYLINDER_MULTIFONCTION_PUSH,	0,	ACT_QUEUE_Small_cylinder_multifonction, SELFTEST_ACT_AX12_SMALL_CYLINDER_MULTIFONCTION },
			{18, ACT_SMALL_CYLINDER_MULTIFONCTION,	ACT_SMALL_CYLINDER_MULTIFONCTION_LOCK,	0,	ACT_QUEUE_Small_cylinder_multifonction, SELFTEST_ACT_AX12_SMALL_CYLINDER_MULTIFONCTION },
			{19, ACT_SMALL_CYLINDER_MULTIFONCTION,	ACT_SMALL_CYLINDER_MULTIFONCTION_IN,	0,	ACT_QUEUE_Small_cylinder_multifonction, SELFTEST_ACT_AX12_SMALL_CYLINDER_MULTIFONCTION },

			{20, ACT_SMALL_CYLINDER_ARM,		ACT_SMALL_CYLINDER_ARM_TAKE,			0,		ACT_QUEUE_Small_cylinder_arm, 			SELFTEST_ACT_AX12_SMALL_CYLINDER_ARM },
			{21, ACT_SMALL_CYLINDER_DISPOSE,	ACT_SMALL_CYLINDER_DISPOSE_DISPOSE,		0,		ACT_QUEUE_Small_cylinder_dispose, 		SELFTEST_ACT_AX12_SMALL_CYLINDER_DISPOSE },
			{21, ACT_SMALL_POMPE_DISPOSE,		ACT_POMPE_NORMAL,						100,	ACT_QUEUE_Small_pompe_dispose, 			SELFTEST_ACT_AX12_SMALL_POMPE_DISPOSE },
			{23, ACT_SMALL_CYLINDER_BALANCER,	ACT_SMALL_CYLINDER_BALANCER_OUT,		0,		ACT_QUEUE_Small_cylinder_balancer, 		SELFTEST_ACT_AX12_SMALL_CYLINDER_BALANCER },
			{24, ACT_SMALL_CYLINDER_BALANCER,	ACT_SMALL_CYLINDER_BALANCER_IDLE,		0,		ACT_QUEUE_Small_cylinder_balancer, 		SELFTEST_ACT_AX12_SMALL_CYLINDER_BALANCER },
			...
			{29, ACT_SMALL_MAGIC_ARM,			ACT_SMALL_MAGIC_ARM_IN,					0,		ACT_QUEUE_Small_magic_arm, 				SELFTEST_ACT_AX12_SMALL_MAGIC_ARM },
			...
			{32, ACT_SMALL_CYLINDER_POUSSIX,	ACT_SMALL_CYLINDER_POUSSIX_MID,			0,		ACT_QUEUE_Small_cylinder_poussix, 		SELFTEST_ACT_AX12_SMALL_POUSSIX},
			{33, ACT_SMALL_CYLINDER_POUSSIX,	ACT_SMALL_CYLINDER_POUSSIX_DOWN,			0,		ACT_QUEUE_Small_cylinder_poussix, 		SELFTEST_ACT_AX12_SMALL_POUSSIX},
			{34, ACT_SMALL_CYLINDER_POUSSIX,	ACT_SMALL_CYLINDER_POUSSIX_UP,		0,		ACT_QUEUE_Small_cylinder_poussix, 		SELFTEST_ACT_AX12_SMALL_POUSSIX},
	};
