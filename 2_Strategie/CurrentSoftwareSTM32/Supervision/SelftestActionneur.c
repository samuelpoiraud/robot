...
error_e SELFTESTACT_run(){
	...
	static const struct_selftest_t tableau_selftest_big[]  = {
				...
				{1, ACT_CYLINDER_ELEVATOR_RIGHT,	 ACT_CYLINDER_ELEVATOR_RIGHT_TOP,		 0,		ACT_QUEUE_Cylinder_elevator_right, 	SELFTEST_ACT_RX24_CYLINDER_ELEVATOR_RIGHT },
				{1, ACT_CYLINDER_ELEVATOR_LEFT, 	 ACT_CYLINDER_ELEVATOR_LEFT_TOP,		 0,		ACT_QUEUE_Cylinder_elevator_left, 		SELFTEST_ACT_RX24_CYLINDER_ELEVATOR_LEFT  },
				{2, ACT_CYLINDER_ELEVATOR_RIGHT,	 ACT_CYLINDER_ELEVATOR_RIGHT_BOTTOM,	 0,		ACT_QUEUE_Cylinder_elevator_right,		SELFTEST_ACT_RX24_CYLINDER_ELEVATOR_RIGHT },
				{2, ACT_CYLINDER_ELEVATOR_LEFT,		 ACT_CYLINDER_ELEVATOR_LEFT_BOTTOM,		 0,		ACT_QUEUE_Cylinder_elevator_left,		SELFTEST_ACT_RX24_CYLINDER_ELEVATOR_LEFT  },
				{3, ACT_CYLINDER_SLIDER_RIGHT,		 ACT_CYLINDER_SLIDER_RIGHT_ALMOST_OUT,	 0,		ACT_QUEUE_Cylinder_slider_right,		SELFTEST_ACT_RX24_CYLINDER_SLIDER_RIGHT   },
				{3, ACT_CYLINDER_SLIDER_LEFT,		 ACT_CYLINDER_SLIDER_LEFT_ALMOST_OUT,	 0,		ACT_QUEUE_Cylinder_slider_left, 		SELFTEST_ACT_RX24_CYLINDER_SLIDER_LEFT    },
				{3, ACT_CYLINDER_SLOPE_RIGHT,		 ACT_CYLINDER_SLOPE_RIGHT_UP,			 0,		ACT_QUEUE_Cylinder_slope_right,		SELFTEST_ACT_AX12_CYLINDER_SLOPE_RIGHT    },
				{3, ACT_CYLINDER_SLOPE_LEFT,		 ACT_CYLINDER_SLOPE_LEFT_UP,			 0,		ACT_QUEUE_Cylinder_slope_left,			SELFTEST_ACT_AX12_CYLINDER_SLOPE_LEFT     },
				{4, ACT_CYLINDER_SLIDER_RIGHT,		 ACT_CYLINDER_SLIDER_RIGHT_IN,			 0,		ACT_QUEUE_Cylinder_slider_right,		SELFTEST_ACT_RX24_CYLINDER_SLIDER_RIGHT   },
				{4, ACT_CYLINDER_SLIDER_LEFT,		 ACT_CYLINDER_SLIDER_LEFT_IN,			 0,		ACT_QUEUE_Cylinder_slider_left,		SELFTEST_ACT_RX24_CYLINDER_SLIDER_LEFT    },
				{4, ACT_CYLINDER_SLOPE_RIGHT,		 ACT_CYLINDER_SLOPE_RIGHT_DOWN,			 0,		ACT_QUEUE_Cylinder_slope_right,		SELFTEST_ACT_AX12_CYLINDER_SLOPE_RIGHT    },
				{4, ACT_CYLINDER_SLOPE_LEFT,		 ACT_CYLINDER_SLOPE_LEFT_DOWN,			 0,		ACT_QUEUE_Cylinder_slope_left,			SELFTEST_ACT_AX12_CYLINDER_SLOPE_LEFT     },


				//actionneurs depose cote droit

				{5, ACT_CYLINDER_PUSHER_RIGHT,		 ACT_CYLINDER_PUSHER_RIGHT_OUT,			 0,		ACT_QUEUE_Cylinder_slope_right,		SELFTEST_ACT_AX12_CYLINDER_PUSHER_RIGHT    },
				{5, ACT_CYLINDER_ARM_RIGHT,			 ACT_CYLINDER_ARM_RIGHT_OUT,			 0,		ACT_QUEUE_Cylinder_arm_right,			SELFTEST_ACT_RX24_CYLINDER_ARM_RIGHT       },
				{6, ACT_CYLINDER_PUSHER_RIGHT,		 ACT_CYLINDER_PUSHER_RIGHT_IN,			 0,		ACT_QUEUE_Cylinder_slope_right,		SELFTEST_ACT_AX12_CYLINDER_PUSHER_RIGHT    },
				{6, ACT_CYLINDER_DISPOSE_RIGHT,		 ACT_CYLINDER_DISPOSE_RIGHT_TAKE,		 0,		ACT_QUEUE_Cylinder_dispose_right,		SELFTEST_ACT_AX12_CYLINDER_DISPOSE_RIGHT   },
				{6, ACT_CYLINDER_COLOR_RIGHT,		 ACT_CYLINDER_COLOR_RIGHT_NORMAL_SPEED,	 0,		ACT_QUEUE_Cylinder_color_right,		SELFTEST_ACT_RX24_CYLINDER_COLOR_RIGHT     },
				{7, ACT_CYLINDER_DISPOSE_RIGHT,		 ACT_CYLINDER_DISPOSE_RIGHT_RAISE,		 0,		ACT_QUEUE_Cylinder_dispose_right,		SELFTEST_ACT_AX12_CYLINDER_DISPOSE_RIGHT   },
				{8, ACT_CYLINDER_COLOR_RIGHT,		 ACT_CYLINDER_COLOR_RIGHT_ZERO_SPEED,	 0,		ACT_QUEUE_Cylinder_color_right,		SELFTEST_ACT_RX24_CYLINDER_COLOR_RIGHT     },
				{8, ACT_CYLINDER_DISPOSE_RIGHT,		 ACT_CYLINDER_DISPOSE_RIGHT_DISPOSE,	 0,		ACT_QUEUE_Cylinder_dispose_right,		SELFTEST_ACT_AX12_CYLINDER_DISPOSE_RIGHT   },
				//besoin de retourner a l'etat raise ?
				{9, ACT_CYLINDER_DISPOSE_RIGHT,		 ACT_CYLINDER_DISPOSE_RIGHT_TAKE,		 0,		ACT_QUEUE_Cylinder_dispose_right,		SELFTEST_ACT_AX12_CYLINDER_DISPOSE_RIGHT   },
				{10, ACT_CYLINDER_DISPOSE_RIGHT,	 ACT_CYLINDER_DISPOSE_RIGHT_STOP,		 0,		ACT_QUEUE_Cylinder_dispose_right,		SELFTEST_ACT_AX12_CYLINDER_DISPOSE_RIGHT   },
				{11, ACT_CYLINDER_ARM_RIGHT,		 ACT_CYLINDER_ARM_RIGHT_IN,				 0,		ACT_QUEUE_Cylinder_arm_right,			SELFTEST_ACT_RX24_CYLINDER_ARM_RIGHT       },
				{11, ACT_CYLINDER_BALANCER_RIGHT,	 ACT_CYLINDER_BALANCER_RIGHT_IN,	 	 0,		ACT_QUEUE_Cylinder_balancer_right,		SELFTEST_ACT_AX12_CYLINDER_BALANCER_RIGHT  },
				{12, ACT_CYLINDER_BALANCER_RIGHT,	 ACT_CYLINDER_BALANCER_RIGHT_OUT,		 0,		ACT_QUEUE_Cylinder_balancer_right,		SELFTEST_ACT_AX12_CYLINDER_BALANCER_RIGHT  },


				//actionneurs depose cote gauche

				{13, ACT_CYLINDER_PUSHER_LEFT,		 ACT_CYLINDER_PUSHER_LEFT_OUT,			 0,		ACT_QUEUE_Cylinder_slope_left,			SELFTEST_ACT_AX12_CYLINDER_PUSHER_LEFT    },
				{14, ACT_CYLINDER_ARM_LEFT,			 ACT_CYLINDER_ARM_LEFT_OUT,			 	 0,		ACT_QUEUE_Cylinder_arm_left,			SELFTEST_ACT_RX24_CYLINDER_ARM_LEFT       },
				{15, ACT_CYLINDER_PUSHER_LEFT,		 ACT_CYLINDER_PUSHER_LEFT_IN,			 0,		ACT_QUEUE_Cylinder_slope_left,			SELFTEST_ACT_AX12_CYLINDER_PUSHER_LEFT    },
				{16, ACT_CYLINDER_DISPOSE_LEFT,		 ACT_CYLINDER_DISPOSE_LEFT_TAKE,		 0,		ACT_QUEUE_Cylinder_dispose_right,		SELFTEST_ACT_AX12_CYLINDER_DISPOSE_LEFT   },
				{16, ACT_CYLINDER_COLOR_LEFT,		 ACT_CYLINDER_COLOR_LEFT_NORMAL_SPEED,	 0,		ACT_QUEUE_Cylinder_color_right,		SELFTEST_ACT_RX24_CYLINDER_COLOR_LEFT     },
				{17, ACT_CYLINDER_DISPOSE_LEFT,		 ACT_CYLINDER_DISPOSE_LEFT_RAISE,		 0,		ACT_QUEUE_Cylinder_dispose_right,		SELFTEST_ACT_AX12_CYLINDER_DISPOSE_LEFT   },
				{18, ACT_CYLINDER_COLOR_LEFT,		 ACT_CYLINDER_COLOR_LEFT_ZERO_SPEED,	 0,		ACT_QUEUE_Cylinder_color_right,		SELFTEST_ACT_RX24_CYLINDER_COLOR_LEFT     },
				{18, ACT_CYLINDER_DISPOSE_LEFT,		 ACT_CYLINDER_DISPOSE_LEFT_DISPOSE,		 0,		ACT_QUEUE_Cylinder_dispose_right,		SELFTEST_ACT_AX12_CYLINDER_DISPOSE_LEFT   },
				{19, ACT_CYLINDER_DISPOSE_LEFT,		 ACT_CYLINDER_DISPOSE_LEFT_TAKE,		 0,		ACT_QUEUE_Cylinder_dispose_right,		SELFTEST_ACT_AX12_CYLINDER_DISPOSE_LEFT   },
				{20, ACT_CYLINDER_DISPOSE_LEFT,		 ACT_CYLINDER_DISPOSE_LEFT_STOP,		 0,		ACT_QUEUE_Cylinder_dispose_right,		SELFTEST_ACT_AX12_CYLINDER_DISPOSE_LEFT   },
				{21, ACT_CYLINDER_ARM_LEFT,			 ACT_CYLINDER_ARM_LEFT_IN,				 0,		ACT_QUEUE_Cylinder_arm_left,			SELFTEST_ACT_RX24_CYLINDER_ARM_LEFT       },
				{21, ACT_CYLINDER_BALANCER_LEFT,	 ACT_CYLINDER_BALANCER_LEFT_IN,			 0,		ACT_QUEUE_Cylinder_balancer_right,		SELFTEST_ACT_AX12_CYLINDER_BALANCER_LEFT },
				{22, ACT_CYLINDER_BALANCER_LEFT,	 ACT_CYLINDER_BALANCER_LEFT_OUT,		 0,		ACT_QUEUE_Cylinder_balancer_right,		SELFTEST_ACT_AX12_CYLINDER_BALANCER_LEFT },


				//actionneur prise balle

				{23, ACT_ORE_WALL,	 				 ACT_ORE_WALL_OUT,						 0,							ACT_QUEUE_Ore_wall,					SELFTEST_ACT_RX24_ORE_WALL },
				{24, ACT_ORE_TRIHOLE,	 			 ACT_ORE_TRIHOLE_RUN,					 ACT_TRIHOLE_SPEED_RUN,		ACT_QUEUE_Ore_trihole,					SELFTEST_ACT_RX24_ORE_TRIHOLE },
				{24, ACT_ORE_ROLLER_ARM,	 		 ACT_ORE_ROLLER_ARM_OUT,				 0,							ACT_QUEUE_Ore_roller_arm,				SELFTEST_ACT_RX24_ORE_ROLLER_ARM },
				{25, ACT_ORE_ROLLER_FOAM,	 		 ACT_ORE_ROLLER_FOAM_RUN,				 ACT_ROLLER_FOAM_SPEED_RUN,	ACT_QUEUE_Ore_roller_foam,				SELFTEST_ACT_RX24_ORE_FOAM },
				{26, ACT_ORE_ROLLER_FOAM,	 		 ACT_ORE_ROLLER_FOAM_STOP,				 0,							ACT_QUEUE_Ore_roller_foam,				SELFTEST_ACT_RX24_ORE_FOAM },
				{27, ACT_ORE_ROLLER_ARM,	 		 ACT_ORE_ROLLER_ARM_IN,					 0,							ACT_QUEUE_Ore_roller_arm,				SELFTEST_ACT_RX24_ORE_ROLLER_ARM },
				{27, ACT_ORE_TRIHOLE,	 			 ACT_ORE_TRIHOLE_STOP,					 0,							ACT_QUEUE_Ore_trihole,					SELFTEST_ACT_RX24_ORE_TRIHOLE },
				{28, ACT_ORE_WALL,	 				 ACT_ORE_WALL_IN,						 0,							ACT_QUEUE_Ore_wall,					SELFTEST_ACT_RX24_ORE_WALL },
				{29, ACT_ORE_GUN,	 				 ACT_ORE_GUN_DOWN,						 0,							ACT_QUEUE_Ore_gun,						SELFTEST_ACT_RX24_ORE_GUN },
				{30, ACT_ORE_GUN,	 				 ACT_ORE_GUN_UP,						 0,							ACT_QUEUE_Ore_gun,						SELFTEST_ACT_RX24_ORE_GUN },
	...
	static const struct_selftest_t tableau_selftest_small[]  = {
			...
			{19, ACT_SMALL_CYLINDER_ARM,		ACT_SMALL_CYLINDER_ARM_TAKE,			0,		ACT_QUEUE_Small_cylinder_arm, 			SELFTEST_ACT_AX12_SMALL_CYLINDER_ARM },
			{20, ACT_SMALL_CYLINDER_DISPOSE,	ACT_SMALL_CYLINDER_DISPOSE_DISPOSE,		0,		ACT_QUEUE_Small_cylinder_dispose, 		SELFTEST_ACT_AX12_SMALL_CYLINDER_DISPOSE },
			{20, ACT_SMALL_POMPE_DISPOSE,		ACT_POMPE_NORMAL,						100,	ACT_QUEUE_Small_pompe_dispose, 			SELFTEST_ACT_AX12_SMALL_POMPE_DISPOSE },
			{21, ACT_SMALL_CYLINDER_DISPOSE,	ACT_SMALL_CYLINDER_DISPOSE_IDLE,		0,		ACT_QUEUE_Small_cylinder_dispose, 		SELFTEST_ACT_AX12_SMALL_CYLINDER_DISPOSE },
			{21, ACT_SMALL_POMPE_DISPOSE,		ACT_POMPE_STOP,							0,		ACT_QUEUE_Small_pompe_dispose, 			SELFTEST_ACT_AX12_SMALL_POMPE_DISPOSE },
			{22, ACT_SMALL_CYLINDER_ARM,		ACT_SMALL_CYLINDER_ARM_IN,				0,		ACT_QUEUE_Small_cylinder_arm, 			SELFTEST_ACT_AX12_SMALL_CYLINDER_ARM },

			{23, ACT_SMALL_MAGIC_ARM,			ACT_SMALL_MAGIC_ARM_OUT,				0,		ACT_QUEUE_Small_magic_arm, 				SELFTEST_ACT_AX12_SMALL_MAGIC_ARM },
			{24, ACT_SMALL_MAGIC_COLOR,			ACT_SMALL_MAGIC_COLOR_NORMAL_SPEED,		0,		ACT_QUEUE_Small_magic_color, 			SELFTEST_ACT_AX12_SMALL_MAGIC_COLOR },
			{25, ACT_SMALL_MAGIC_COLOR,			ACT_SMALL_MAGIC_COLOR_ZERO_SPEED,		0,		ACT_QUEUE_Small_magic_color, 			SELFTEST_ACT_AX12_SMALL_MAGIC_COLOR },
			{26, ACT_SMALL_MAGIC_ARM,			ACT_SMALL_MAGIC_ARM_OUT,				0,		ACT_QUEUE_Small_magic_arm, 				SELFTEST_ACT_AX12_SMALL_MAGIC_ARM },

			{27, ACT_SMALL_ORE,					ACT_SMALL_ORE_DOWN,						0,		ACT_QUEUE_Small_ore, 					SELFTEST_ACT_AX12_SMALL_ORE},
			{28, ACT_SMALL_ORE,					ACT_SMALL_ORE_UP,						0,		ACT_QUEUE_Small_ore, 					SELFTEST_ACT_AX12_SMALL_ORE},
