...
error_e SELFTESTACT_run(){
	...
	static const struct_selftest_t tableau_selftest_small[]  = {
			...
			{1, ACT_SMALL_BALL_BACK_LEFT,	 	ACT_SMALL_BALL_BACK_LEFT_UP,		 	0,		ACT_QUEUE_Small_bearing_back_left, 		SELFTEST_ACT_AX12_SMALL_BALL_BACK_LEFT },
			{2, ACT_SMALL_BALL_BACK_LEFT,	 	ACT_SMALL_BALL_BACK_LEFT_DOWN,		 	0,		ACT_QUEUE_Small_bearing_back_left, 		SELFTEST_ACT_AX12_SMALL_BALL_BACK_LEFT },
			{3, ACT_SMALL_BALL_BACK_RIGHT,	 	ACT_SMALL_BALL_BACK_RIGHT_UP,		 	0,		ACT_QUEUE_Small_bearing_back_right, 	SELFTEST_ACT_AX12_SMALL_BALL_BACK_RIGHT },
			{4, ACT_SMALL_BALL_BACK_RIGHT,	 	ACT_SMALL_BALL_BACK_RIGHT_DOWN,		 	0,		ACT_QUEUE_Small_bearing_back_right, 	SELFTEST_ACT_AX12_SMALL_BALL_BACK_RIGHT },
