...
void VERBOSE_CAN_MSG_print(CAN_msg_t * msg)
{
	...
	switch(msg->sid)
	{
		...
		case SUPER_ASK_CONFIG:					debug_printf("%x SUPER_ASK_CONFIG                 	", SUPER_ASK_CONFIG					);	break;
		case SUPER_ASK_STRAT_SELFTEST:			debug_printf("%x SUPER_ASK_STRAT_SELFTEST         	", SUPER_ASK_STRAT_SELFTEST			);	break;
		...
		case BEACON_US_SELFTEST:				debug_printf("%x BEACON_US_SELFTEST               	", BEACON_US_SELFTEST				);	break;
...
//		case SUPER_ASK_CONFIG:					debug_printf("|\n");												break;
