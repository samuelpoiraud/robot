...
//--------------------------------------------------------------------------------------------------------------------------------------
	...
	static astar_node_t astar_nodes[NB_NODES] =
	{
		...
		//Rangée [A]
		(astar_node_t){ A1, {600,  300}, (1ULL<<A2)|(1ULL<<B1)},
		(astar_node_t){ A2, {1000, 400}, (1ULL<<A1)|(1ULL<<B1)|(1<<B2)|(1<<B3)},
		(astar_node_t){ A3, {1250, 300}, (1ULL<<A3)|(1ULL<<B2)},

		//Rangée [B]
		(astar_node_t){ B1, {900,  700}, (1ULL<<A1)|(1ULL<<A2)|(1ULL<<B2)|(1ULL<<C1)|(1ULL<<C2)},
		(astar_node_t){ B2, {1300, 700}, (1ULL<<A2)|(1ULL<<A3)|(1ULL<<B3)|(1ULL<<B1)|(1ULL<<C2)|(1ULL<<D3)},
		(astar_node_t){ B3, {1700, 750}, (1ULL<<B2)|(1ULL<<A3)},

		//Rangée [C]
		(astar_node_t){ C1, {700,  1000}, (1ULL<<B1)|(1ULL<<C2)|(1ULL<<D1)|(1ULL<<D2)|(1ULL<<D3)},
		(astar_node_t){ C2, {1050, 950}, (1ULL<<B1)|(1ULL<<B2)|(1ULL<<C1)|(1ULL<<D2)|(1ULL<<D3)},

		//Rangée [D]
		(astar_node_t){ D1, {300,  1300}, (1ULL<<C1)|(1ULL<<D2)|(1ULL<<E1)|(1ULL<<F1)},
		(astar_node_t){ D2, {800,  1300}, (1ULL<<C1)|(1ULL<<C2)|(1ULL<<D1)|(1ULL<<D3)|(1ULL<<E1)|(1ULL<<E2)},
		(astar_node_t){ D3, {1200, 1200}, (1ULL<<B2)|(1ULL<<C2)|(1ULL<<D2)|(1ULL<<E2)},

		//Rangée [E]
		(astar_node_t){ E1, {500,  1500}, (1ULL<<D1)|(1ULL<<D2)|(1ULL<<F1)|(1ULL<<F2)},
		(astar_node_t){ E2, {900, 1500}, (1ULL<<D2)|(1ULL<<D3)|(1ULL<<E1)|(1ULL<<F2)|(1ULL<<F3)},

		//Rangée [F]
		(astar_node_t){ F1, {300,  1700}, (1ULL<<D1)|(1ULL<<E1)|(1ULL<<F2)|(1ULL<<G1)},
		(astar_node_t){ F2, {800,  1700}, (1ULL<<E1)|(1ULL<<E2)|(1ULL<<F1)||(1ULL<<F3)(1ULL<<G1)|(1ULL<<G2)},
		(astar_node_t){ F3, {1200, 1800}, (1ULL<<E2)|(1ULL<<F2)|(1ULL<<G1)|(1ULL<<G2)|(1ULL<<H2)},

		//Rangée [G]
		(astar_node_t){ G1, {700,  2000}, (1ULL<<F1)|(1ULL<<F2)|(1ULL<<F3)|(1ULL<<G2)|(1ULL<<H1)},
		(astar_node_t){ G2, {1050, 2050}, (1ULL<<F2)|(1ULL<<F3)|(1ULL<<G1)|(1ULL<<H1)|(1ULL<<H2)},

		//Rangée [H]
		(astar_node_t){ H1, {900,  2300}, (1ULL<<G1)|(1ULL<<G2)|(1ULL<<H2)|(1ULL<<H3)|(1ULL<<I1)|(1ULL<<I2)|(1ULL<<I3)},
		(astar_node_t){ H2, {1300,  2300}, (1ULL<<F3)|(1ULL<<G2)|(1ULL<<H1)|(1ULL<<H3)|(1ULL<<I1)|(1ULL<<I2)},
		(astar_node_t){ H3, {1700, 2250}, (1ULL<<H2)|(1ULL<<I3)},

		//Rangée [I]
		(astar_node_t){ I1, {600,  2700}, (1ULL<<H1)|(1ULL<<I2)|(1ULL<<I3)},
		(astar_node_t){ I2, {1000, 2600}, (1ULL<<H1)|(1ULL<<H2)|(1ULL<<I1)|(1ULL<<I3)},
		(astar_node_t){ I3, {1250, 2700}, (1ULL<<H2)|(1ULL<<I1)|(1ULL<<I2)},
	...
	static astar_neighbor_t astar_curves[NB_NODES] =
	{
		...
		//Rangée [A]
		(1ULL<<A2)|(1ULL<<B1)|(1ULL<<FROM_NODE),//On est en A1, les courbes sont autorisées lorsque l'on vient de A2 ou de B1
		(1ULL<<A1)|(1ULL<<B1)|(1<<B2)|(1<<B3)|(1ULL<<FROM_NODE),
		(1ULL<<A3)|(1ULL<<B2)|(1ULL<<FROM_NODE),

		//Rangée [B]
		(1ULL<<A1)|(1ULL<<A2)|(1ULL<<B2)|(1ULL<<C1)|(1ULL<<C2)|(1ULL<<FROM_NODE),
		(1ULL<<A2)|(1ULL<<A3)|(1ULL<<B3)|(1ULL<<B1)|(1ULL<<C2)|(1ULL<<D3)|(1ULL<<FROM_NODE),
		(1ULL<<B2)|(1ULL<<A3)|(1ULL<<FROM_NODE),

		//Rangée [C]
		(1ULL<<B1)|(1ULL<<C2)|(1ULL<<D1)|(1ULL<<D2)|(1ULL<<D3)|(1ULL<<FROM_NODE),
		(1ULL<<B1)|(1ULL<<B2)|(1ULL<<C1)|(1ULL<<D2)|(1ULL<<D3)|(1ULL<<FROM_NODE),

		//Rangée [D]
		(1ULL<<C1)|(1ULL<<D2)|(1ULL<<E1)|(1ULL<<F1)|(1ULL<<FROM_NODE),
		(1ULL<<C1)|(1ULL<<C2)|(1ULL<<D1)|(1ULL<<D3)|(1ULL<<E1)|(1ULL<<E2)|(1ULL<<FROM_NODE),
		(1ULL<<B2)|(1ULL<<C2)|(1ULL<<D2)|(1ULL<<E2)|(1ULL<<FROM_NODE),

		//Rangée [E]
		(1ULL<<D1)|(1ULL<<D2)|(1ULL<<F1)|(1ULL<<F2)|(1ULL<<FROM_NODE),
		(1ULL<<D2)|(1ULL<<D3)|(1ULL<<E1)|(1ULL<<F2)|(1ULL<<F3)|(1ULL<<FROM_NODE),

		//Rangée [F]
		(1ULL<<D1)|(1ULL<<E1)|(1ULL<<F2)|(1ULL<<G1)|(1ULL<<FROM_NODE),
		(1ULL<<E1)|(1ULL<<E2)|(1ULL<<F1)||(1ULL<<F3)(1ULL<<G1)|(1ULL<<G2)|(1ULL<<FROM_NODE),
		(1ULL<<E2)|(1ULL<<F2)|(1ULL<<G1)|(1ULL<<G2)|(1ULL<<H2)|(1ULL<<FROM_NODE),

		//Rangée [G]
		(1ULL<<F1)|(1ULL<<F2)|(1ULL<<F3)|(1ULL<<G2)|(1ULL<<H1)|(1ULL<<FROM_NODE),
		(1ULL<<F2)|(1ULL<<F3)|(1ULL<<G1)|(1ULL<<H1)|(1ULL<<H2)|(1ULL<<FROM_NODE),

		//Rangée [H]
		(1ULL<<G1)|(1ULL<<G2)|(1ULL<<H2)|(1ULL<<H3)|(1ULL<<I1)|(1ULL<<I2)|(1ULL<<I3)|(1ULL<<FROM_NODE),
		(1ULL<<F3)|(1ULL<<G2)|(1ULL<<H1)|(1ULL<<H3)|(1ULL<<I1)|(1ULL<<I2)|(1ULL<<FROM_NODE),
		(1ULL<<H2)|(1ULL<<I3)|(1ULL<<FROM_NODE),

		//Rangée [I]
		(1ULL<<H1)|(1ULL<<I2)|(1ULL<<I3)|(1ULL<<FROM_NODE),
		(1ULL<<H1)|(1ULL<<H2)|(1ULL<<I1)|(1ULL<<I3)|(1ULL<<FROM_NODE),
		(1ULL<<H2)|(1ULL<<I1)|(1ULL<<I2)|(1ULL<<FROM_NODE),
