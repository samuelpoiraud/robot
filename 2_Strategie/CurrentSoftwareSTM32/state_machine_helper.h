...
typedef enum {
	...
	SM_ID_STRAT_PEARL_INITIALE						= 0x0121,
	SM_ID_SUB_PEARL_TAKE_SAND_BLOC_NEXT_DUNE	    = 0x0122,
	SM_ID_SUB_PEARL_TAKE_SAND_BLOC_START_ZONE	    = 0x0123,
	SM_ID_SUB_PEARL_CLOSE_DOORS 	                = 0x0124,
	SM_ID_SUB_COLLECT_COQUILLAGES_ONE_CLOSE			= 0x0125,
	SM_ID_SUB_COLLECT_COQUILLAGES_TWO_CLOSE			= 0x0126,
	SM_ID_SUB_COLLECT_COQUILLAGES_THREE_AND_FOUR_CLOSE		= 0x0127,
	SM_ID_SUB_COLLECT_COQUILLAGES_FIVE_CLOSE		= 0x0128,
	SM_ID_SUB_COLLECT_COQUILLAGES_ONE_FAR			= 0x0129,
	SM_ID_SUB_COLLECT_COQUILLAGES_TWO_FAR			= 0x0130,
	SM_ID_SUB_COLLECT_COQUILLAGES_THREE_FAR			= 0x0131,
	SM_ID_SUB_COLLECT_COQUILLAGES_FOUR_FAR			= 0x0132,
	SM_ID_SUB_COLLECT_COQUILLAGES_FIVE_FAR			= 0x0133,
	SM_ID_SUB_LIVRAISON_COQUILLAGES					= 0x0134,
	SM_ID_SUB_PEARL_PLACE_SAND_BLOC_NEXT_DUNE       = 0x0135,
	SM_ID_SUB_COQUILLAGES_CHOICE                    = 0x0136,
	SM_ID_SUB_BLACK_DEPOSE_ALL_SAND_BLOC		    = 0x0137,
	SM_ID_SUB_PEARL_DEPOSE_ALL_SAND_BLOC			= 0x0138,
