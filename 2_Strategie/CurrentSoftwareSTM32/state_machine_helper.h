...
typedef enum {
	...
	SM_ID_SUB_COLLECT_COQUILLAGES_ONE_FAR			= 0x0149,
	SM_ID_SUB_COLLECT_COQUILLAGES_TWO_FAR			= 0x014A,
	SM_ID_SUB_COLLECT_COQUILLAGES_THREE_FAR			= 0x014B,
	SM_ID_SUB_COLLECT_COQUILLAGES_FOUR_FAR			= 0x014C,
	SM_ID_SUB_COLLECT_COQUILLAGES_FIVE_FAR			= 0x014D,
