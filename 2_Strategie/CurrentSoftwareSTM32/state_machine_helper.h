...
typedef enum {
	...
	SM_ID_STRAT_HOLLY_LEROY_MERLIN_INIT             = 0x0115,
	SM_ID_STRAT_HOLLY_LEROY_MERLIN_NORTH            = 0x0116,
	SM_ID_STRAT_HOLLY_LEROY_MERLIN_SOUTH            = 0x0117,
	SM_ID_STRAT_HOLLY_LEROY_MERLIN_DISPOSE          = 0x0118,
	SM_ID_STRAT_HOLLY_LEROY_MERLIN_AVOIDANCE        = 0x0119,
	...
	SM_ID_STRAT_WOOD_DISPOSE_CUP					= 0x0125,
	SM_ID_STRAT_WOOD_POSE_ONE_CUP					= 0x0126,
	SM_ID_STRAT_WOOD_COLLECT_CUP_SOUTH_YELLOW		= 0x0127,
	SM_ID_STRAT_WOOD_COLLECT_CUP_SOUTH_GREEN		= 0x0128,
	SM_ID_STRAT_WOOD_COLLECT_CUP_MIDDLE				= 0x0129,
	SM_ID_STRAT_WOOD_COLLECT_CUP_NORTH_YELLOW		= 0x0130,
	SM_ID_STRAT_WOOD_COLLECT_CUP_NORTH_GREEN		= 0x0131,
	SM_ID_STRAT_WOOD_COLLECT_CUP_GLOBAL				= 0x0132,
	SM_ID_STRAT_WOOD_DISPOSE_STOLEN_CUP				= 0x0133,
	SM_ID_SUB_WOOD_SCAN_AND_STEAL_NORTH_CUP			= 0x0134,
	SM_ID_STRAT_WOOD_DISPOSE_CUP_END_MATCH			= 0x0135,
	SM_ID_STRAT_WOOD_PUSH_ADV_NORTH_CUP				= 0x0136,
	SM_ID_STRAT_WOOD_PROTECT_NORTH					= 0x0137,
	SM_ID_STRAT_WOOD_PROTECT_SOUTH					= 0x0138,
	SM_ID_STRAT_WOOD_PROTECT_SOUTH_AND_NORTH		= 0x0139,
	SM_ID_STRAT_WOOD_GET_OUR_POPCORN				= 0x0140,
	SM_ID_STRAT_WOOD_PUSH_FEET						= 0x0141,
	SM_ID_STRAT_WOOD_DISPOSE_CUP_NORTH				= 0x0142,
	SM_ID_STRAT_WOOD_DISPOSE_CUP_SOUTH				= 0x0143,
	SM_ID_STRAT_WOOD_CHOOSE_ACTION					= 0x0144,
	SM_ID_STRAT_WOOD_WAITING_TO_GO					= 0x0145,
	SM_ID_STRAT_WOOD_GO_POSITION_END_OF_MATCH		= 0x0146,
	SM_ID_COLLECT_ADV_POP_CORN						= 0x0147,
	SM_ID_SUB_WOOD_SCAN_AND_STEAL_SOUTH_CUP			= 0x0148,
	SM_ID_SUB_WOOD_CHOOSE_CINE_TO_SCAN				= 0x0149,

	//0x200 SUBACTIONS
	SM_ID_SUB_RECALAGE_X							= 0x0201,
	SM_ID_SUB_RECALAGE_Y							= 0x0202,
	SM_ID_SUB_DISPOSE_IN_START_ZONE					= 0x0203,
	SM_ID_SUB_MIDDLE_FEET_GATHERING					= 0x0204,
	SM_ID_SUB_NORTH_GATHERING						= 0x0205,
	SM_ID_SUB_NORTH_GATHERING_NO_REAR_FOOT			= 0x0206,
	SM_ID_SUB_NORTH_GATHERING_REAR_FEET				= 0x0207,
	SM_ID_SUB_NORTH_GATHERING_STAIRS_FEET			= 0x0208,
	SM_ID_SUB_SOUTH_GATHERING						= 0x0209,
	SM_ID_SUB_DISPOSE_CARPETS						= 0x020A,
	SM_ID_SUB_HOLLY_CARPET_LAUNCHER					= 0x020B,
	SM_ID_SUB_HOLLY_SCAN_DISPOSE_ON_ESTRAD			= 0x020C,
	SM_ID_SUB_HOLLY_TAKE_REAR_FEET_IN_LIFT			= 0x020D,
	SM_ID_SUB_HOLLY_END_OF_MATCH					= 0x020E,
	SM_ID_HOLLY_GO_TO_NORTH							= 0x020F,
	SM_ID_SUB_HOLLY_OUR_CLAP						= 0x0210,
	SM_ID_SUB_DO_SPOT_WITH_MIDDLE_FEET				= 0x0211,
	SM_ID_WOOD_ASK_FOR_ACCESS_SCAN					= 0x0212,
	SM_ID_SUB_HOLLY_TEST_ACT						= 0x0213,
	SM_ID_SUB_WOOD_TEST_ACT							= 0x0214,
	SM_ID_HOLLY_ASK_PROTECT							= 0x0215,
	SM_ID_HOLLY_MAE_SPOTIX							= 0x0216,
	SM_ID_HOLLY_MANAGE_MAE_SPOTIX					= 0x0217,
	SM_ID_HOLLY_MANAGE_MAE_CUP						= 0x0218,
