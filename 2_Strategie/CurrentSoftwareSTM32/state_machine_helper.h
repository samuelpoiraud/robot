...
typedef enum {
	...
	SM_ID_STRAT_WOOD_DISPOSE_CUP_NORTH		   = 0x142,
	SM_ID_STRAT_WOOD_DISPOSE_CUP_SOUTH		   = 0x143,
	SM_ID_STRAT_WOOD_CHOOSE_ACTION			   = 0x144,
	SM_ID_STRAT_WOOD_WAITING_TO_GO			   = 0x145,
	SM_ID_STRAT_WOOD_GO_POSITION_END_OF_MATCH  = 0x146,
	SM_ID_COLLECT_ADV_POP_CORN				   = 0x147,
	SM_ID_SUB_WOOD_SCAN_AND_STEAL_SOUTH_CUP    = 0x148,
	SM_ID_SUB_WOOD_CHOOSE_CINE_TO_SCAN         = 0x149,
