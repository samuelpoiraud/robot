...
typedef enum {
	...
	SM_ID_SUB_MANAGER_DEPOSE						= 0x0124,
	SM_ID_SUB_ANTI_RCVA								= 0x0125,
	...
	SM_ID_SUB_PEARL_LACHE_COQUILLAGE_POISSON		= 0x014A,
	SM_ID_SUB_PEARL_LACHE_COQUILLAGE_CONSTRU		= 0x014B,
	...
	SM_ID_SUB_COQUILLAGES_CHOICE_MIDDLE                    = 0x0158,
	...
	SM_ID_SUB_MAKE_SOME_MUSIC_PIRATE                = 0x15A,
	SM_ID_SUB_MAKE_SOME_MUSIC_COLDPLAY                = 0x15B,
	SM_ID_SUB_MAKE_SOME_MUSIC_IMPERIAL_MARCH        =0x15C,
	SM_ID_SUB_MAKE_SOME_MUSIC_PAUL                  =0x15D,
	SM_ID_SUB_MAKE_SOME_MUSIC_LITTLE_PONY           =0x15E,
	SM_ID_SUB_MAKE_SOME_RANDOM_MUSIC				= 0x16C,
