...
typedef enum {
	...
	SM_ID_SUB_COLLECT_FISHS							= 0x0112,
	SM_ID_SUB_RUSH_TO_DUNE						    = 0x0113,
	SM_ID_SUB_DEPOSE_SAND_ELEMENTS				    = 0x0114,
	SM_ID_SUB_BLACK_TAKE_SAND_BLOC_NEXT_DUNE	    = 0x0115,
	SM_ID_SUB_BLACK_CLOSE_DOORS              	    = 0x0116,
