...
typedef enum {
	...
	SM_ID_SUB_COLLECT_COQUILLAGES_ONE_AND_TWO_MIDDLE		= 0x0145,
	SM_ID_SUB_COLLECT_COQUILLAGES_TWO_MIDDLE		= 0x0146,
	SM_ID_SUB_COLLECT_COQUILLAGES_THREE_AND_FOUR_MIDDLE 	= 0x0147,
	SM_ID_SUB_COLLECT_COQUILLAGES_FIVE_MIDDLE		= 0x0148,
