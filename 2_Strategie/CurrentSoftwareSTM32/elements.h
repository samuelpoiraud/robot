...
typedef enum
{
	...
	typedef enum	{
		...
		HOLLY_HAVE_TENIS_BALL_IN_NIPPER,
		...
		HOLLY_DETECTED_NORTH_CUP,
		HOLLY_DETECTED_SOUTH_CUP,
		...
		ELEMENTS_ADV_CLAP,
		ELEMENTS_WOOD_CAN_DO_OUR_CLAP,
		ELEMENTS_WOOD_CAN_GO,
		ELEMENTS_DEFENSE_WOOD_IMPOSED,
		ELEMENTS_FLAGS_NB
	}elements_flags_e;
