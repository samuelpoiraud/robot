...
error_e try_last_row(void){
	...
	switch(state){
		case PUSH:
			state = try_going(550,COLOR_Y(1000),PUSH,PUSH_SLOW,PUSH_SLOW,FAST,FORWARD,NO_DODGE_AND_NO_WAIT);
			break;
		...
		case BACK:
			state = try_going(1000,COLOR_Y(300),BACK,DONE,DONE,FAST,FORWARD,NO_AVOIDANCE);
			break;
